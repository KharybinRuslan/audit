/**
 * Форма «Запрос на аудит»: маска телефона + кастомный селект услуги.
 * Подключается вместе с audit-modal.php — на всех страницах, где есть модалка или только она.
 */
(function () {
  'use strict';
  ...
  function initFormWrap(formWrap) {
    ...
    var form = formWrap.querySelector('form.hero__form');
    if (form) {
      var ret = form.querySelector('input[name="_return"]');
      if (ret && !ret.value) {
