...
$srcPath = $root . '/academy_service_pages_all.php';
...
$sections = [
    ['prefix' => 'accountingCourses', 'file' => 'pages/hsep/kursy-dlya-buhgalterov.php', 'slug' => 'kursy-dlya-buhgalterov'],
    ['prefix' => 'taxCourses', 'file' => 'pages/hsep/kursy-po-nalogam.php', 'slug' => 'kursy-po-nalogam'],
    ['prefix' => 'ifrsTraining', 'file' => 'pages/hsep/obuchenie-msfo.php', 'slug' => 'obuchenie-msfo'],
    ['prefix' => 'internalAuditTraining', 'file' => 'pages/hsep/obuchenie-vnutrennemu-auditu.php', 'slug' => 'obuchenie-vnutrennemu-auditu'],
    ['prefix' => 'auditorQualificationUpgrade', 'file' => 'pages/hsep/povyshenie-kvalifikatsii-auditorov.php', 'slug' => 'povyshenie-kvalifikatsii-auditorov'],
    ['prefix' => 'corporateTraining', 'file' => 'pages/hsep/korporativnoe-obuchenie.php', 'slug' => 'korporativnoe-obuchenie'],
    ['prefix' => 'onlineCourses', 'file' => 'pages/hsep/onlayn-kursy.php', 'slug' => 'onlayn-kursy'],
    ['prefix' => 'seminarsWebinars', 'file' => 'pages/hsep/seminary-i-vebinary.php', 'slug' => 'seminary-i-vebinary'],
    ['prefix' => 'certificationPrograms', 'file' => 'pages/hsep/sertifikatsionnye-programmy.php', 'slug' => 'sertifikatsionnye-programmy'],
];
...
<body class="has-site-header has-breadcrumbs page-hsep-__SLUG__">
...
foreach ($sections as $idx => $meta) {
    ...
    $chunk = preg_replace('/\$serviceCoverHeroBgUrl\s*=\s*\'[^\']*\';/', '$serviceCoverHeroBgUrl = \'/img/audit/obuchenie.webp\';', $chunk, 1);
    $chunk = preg_replace('/\$auditFinalCtaBgUrl\s*=\s*\'[^\']*\';/', '$auditFinalCtaBgUrl = \'/img/audit/obuchenie.webp\';', $chunk, 1);
