...
$srcPath = $root . '/hr_audit_service_pages_all.php';
...
$sections = [
    ['prefix' => 'hrRecordsAudit', 'file' => 'pages/kadrovyy-audit/audit-kadrovogo-deloproizvodstva.php', 'slug' => 'audit-kadrovogo-deloproizvodstva'],
    ['prefix' => 'employmentContractsCheck', 'file' => 'pages/kadrovyy-audit/proverka-trudovyh-dogovorov.php', 'slug' => 'proverka-trudovyh-dogovorov'],
    ['prefix' => 'payrollAccrualAudit', 'file' => 'pages/kadrovyy-audit/audit-nachisleniya-zarplaty.php', 'slug' => 'audit-nachisleniya-zarplaty'],
    ['prefix' => 'laborCodeComplianceCheck', 'file' => 'pages/kadrovyy-audit/proverka-soblyudeniya-tk.php', 'slug' => 'proverka-soblyudeniya-tk'],
    ['prefix' => 'hrRisksFines', 'file' => 'pages/kadrovyy-audit/kadrovye-riski-i-shtrafy.php', 'slug' => 'kadrovye-riski-i-shtrafy'],
    ['prefix' => 'hrRecordsRecovery', 'file' => 'pages/kadrovyy-audit/vosstanovlenie-kadrovogo-ucheta.php', 'slug' => 'vosstanovlenie-kadrovogo-ucheta'],
    ['prefix' => 'hrProcessesSetup', 'file' => 'pages/kadrovyy-audit/postanovka-hr-protsessov.php', 'slug' => 'postanovka-hr-protsessov'],
    ['prefix' => 'hrPolicyDevelopment', 'file' => 'pages/kadrovyy-audit/razrabotka-kadrovoy-politiki.php', 'slug' => 'razrabotka-kadrovoy-politiki'],
    ['prefix' => 'hrDocumentWorkflowAudit', 'file' => 'pages/kadrovyy-audit/audit-hr-dokumentooborota.php', 'slug' => 'audit-hr-dokumentooborota'],
    ['prefix' => 'gitInspectionPrep', 'file' => 'pages/kadrovyy-audit/podgotovka-k-proverkam-git.php', 'slug' => 'podgotovka-k-proverkam-git'],
];
...
<body class="has-site-header has-breadcrumbs page-kadrovyy-audit-__SLUG__">
...
foreach ($sections as $idx => $meta) {
    ...
    $chunk = preg_replace('/\$serviceCoverHeroBgUrl\s*=\s*\'[^\']*\';/', '$serviceCoverHeroBgUrl = \'/img/audit/kardovii-auditjpg.webp\';', $chunk, 1);
    $chunk = preg_replace('/\$auditFinalCtaBgUrl\s*=\s*\'[^\']*\';/', '$auditFinalCtaBgUrl = \'/img/audit/kardovii-auditjpg.webp\';', $chunk, 1);
