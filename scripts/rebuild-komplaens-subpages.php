...
$srcPath = $root . '/compliance_service_pages_all.php';
...
$sections = [
    ['prefix' => 'internalAudit', 'file' => 'pages/komplaens/vnutrenniy-audit.php', 'slug' => 'vnutrenniy-audit'],
    ['prefix' => 'internalControlSystem', 'file' => 'pages/komplaens/postroenie-sistemy-vnutrennego-kontrolya-svk.php', 'slug' => 'postroenie-sistemy-vnutrennego-kontrolya-svk'],
    ['prefix' => 'complianceSystem', 'file' => 'pages/komplaens/komplaens-sistema.php', 'slug' => 'komplaens-sistema'],
    ['prefix' => 'riskManagement', 'file' => 'pages/komplaens/upravlenie-riskami.php', 'slug' => 'upravlenie-riskami'],
    ['prefix' => 'antiCorruptionCompliance', 'file' => 'pages/komplaens/antikorrupcionnyy-komplaens.php', 'slug' => 'antikorrupcionnyy-komplaens'],
    ['prefix' => 'amlCompliance', 'file' => 'pages/komplaens/aml-protivodeystvie-otmyvaniyu.php', 'slug' => 'aml-protivodeystvie-otmyvaniyu'],
    ['prefix' => 'businessRiskAssessment', 'file' => 'pages/komplaens/ocenka-riskov-biznesa.php', 'slug' => 'ocenka-riskov-biznesa'],
];
...
<body class="has-site-header has-breadcrumbs page-komplaens-__SLUG__">
...
foreach ($sections as $idx => $meta) {
    ...
    $chunk = preg_replace('/\$serviceCoverHeroBgUrl\s*=\s*\'[^\']*\';/', '$serviceCoverHeroBgUrl = \'/img/audit/risk-kontrol.webp\';', $chunk, 1);
    $chunk = preg_replace('/\$auditFinalCtaBgUrl\s*=\s*\'[^\']*\';/', '$auditFinalCtaBgUrl = \'/img/audit/risk-kontrol.webp\';', $chunk, 1);
