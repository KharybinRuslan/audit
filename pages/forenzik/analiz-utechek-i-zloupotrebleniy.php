...
$pageTitle = 'Анализ утечек и злоупотреблений';
$pageDescription = 'Анализ утечек и злоупотреблений: проверка утраты данных, передачи информации, использования клиентской базы, нарушений доступа и действий сотрудников.';

$serviceCoverHeroTitle = 'Анализ утечек и злоупотреблений';
$serviceCoverHeroLead = 'Проверим факты утечки информации, незаконного использования клиентской базы, передачи документов, несанкционированного доступа, злоупотребления полномочиями или нарушений внутренних правил. Поможем установить источник, масштаб, возможных участников и последствия для бизнеса.';
...
$serviceCoverHeroNote = 'На старте подскажем, какие цифровые следы и документы важно сохранить, чтобы не потерять доказательства.';
$serviceCoverHeroBgUrl = '/img/audit/forenzik.webp';

$auditOrderReasonsTitle = 'В каких случаях заказывают анализ утечек и злоупотреблений';
...
$auditCheckResultsTitle = 'Что показывает анализ утечек и злоупотреблений';
...
$auditQuestionsTitle = 'Какие задачи решает анализ утечек и злоупотреблений';
$auditQuestionsIntro = 'Проверка помогает быстро понять масштаб инцидента и принять решения по защите бизнеса. Обычно она отвечает на следующие вопросы:';
$auditQuestionsItems = [
...
$auditServiceTypesTitle = 'Что входит в анализ утечек и злоупотреблений';
$auditServiceTypesIntro = 'Состав работ зависит от того, где хранились данные: корпоративная почта, облачные диски, CRM, ERP, мессенджеры, локальные устройства, серверы или внешние сервисы.';
...
$auditProcessTitle = 'Как проводится анализ утечек и злоупотреблений';
...
$auditDeadlinesTitle = 'Сроки проведения услуги «Анализ утечек и злоупотреблений»';
...
$auditPricingTitle = 'Стоимость услуги «Анализ утечек и злоупотреблений»';
...
$auditDocumentsNeededTitle = 'Какие документы нужны для услуги «Анализ утечек и злоупотреблений»';
...
$auditResultsSummaryTitle = 'Что вы получите по итогам услуги «Анализ утечек и злоупотреблений»';
...
$auditMandatoryPrepTitle = 'Обнаружили утечку данных? Поможем сохранить следы и оценить масштаб';
$auditMandatoryPrepIntro = 'При утечке важно не затереть цифровые следы и не менять доступы хаотично. Сначала нужно зафиксировать данные, определить круг пользователей и понять, какие источники информации проверять.';
...
$auditFinalCtaTitle = 'Нужна услуга «Анализ утечек и злоупотреблений»? Начнем с оценки ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Анализ утечек и злоупотреблений»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Анализ утечек и злоупотреблений»?',
...
<body class="has-site-header has-breadcrumbs page-forenzik-analiz-utechek-i-zloupotrebleniy">
