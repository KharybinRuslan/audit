...
$pageTitle = 'Форензик при сделках (M&A)';
$pageDescription = 'Форензик при сделках M&A: проверка рисков мошенничества, скрытых обязательств, сомнительных операций, связанных сторон, контрагентов и достоверности данных перед покупкой бизнеса.';

$serviceCoverHeroTitle = 'Форензик при сделках (M&A)';
$serviceCoverHeroLead = 'Проведем форензик-проверку бизнеса перед покупкой, продажей, привлечением инвестора, объединением компаний или входом в долю. Проверим признаки мошенничества, вывода активов, скрытых обязательств, связанных сторон, сомнительных операций, недостоверной отчетности и рисков, которые могут повлиять на цену сделки.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 7 рабочих дней',
    'Форензик, проверка сделок, связанных сторон и скрытых рисков',
    'Отчет для инвестора, покупателя, продавца или юристов',
];
$serviceCoverHeroNote = 'Предварительно определим периметр проверки, доступные данные, критичные риски и формат отчета для сделки.';
$serviceCoverHeroBgUrl = '/img/audit/forenzik.webp';

$auditOrderReasonsTitle = 'В каких случаях заказывают форензик при сделках M&A';
$auditOrderReasonsIntro = [
    'Форензик при сделках нужен, когда покупатель, инвестор или собственник хочет понять не только финансовые показатели бизнеса, но и скрытые риски: сомнительные операции, связанные стороны, вывод активов, завышенные показатели или потенциальные злоупотребления.',
    'Чаще всего такую проверку проводят в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'планируется покупка бизнеса, доли или актива',
    'инвестор входит в компанию и хочет проверить риски',
    'есть сомнения в достоверности управленческих или финансовых данных',
    'нужно выявить скрытые обязательства, связанные стороны или вывод активов',
    'компания готовится к продаже и хочет заранее устранить проблемные зоны',
    'результаты проверки нужны для переговоров, цены сделки или условий договора',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает форензик при сделках M&A';
$auditCheckResultsParagraphs = [
    'Форензик показывает, есть ли в бизнесе признаки мошенничества, искусственного завышения показателей, вывода активов, скрытых обязательств, зависимых контрагентов, фиктивных операций или иных рисков, которые могут повлиять на стоимость и условия сделки.',
    'По итогам вы получаете отчет с ключевыми находками, уровнем рисков, подтверждающими материалами и рекомендациями для переговоров, структуры сделки и условий договора.',
];

$auditQuestionsTitle = 'Какие задачи решает форензик при сделках M&A';
$auditQuestionsIntro = 'Форензик дополняет финансовый и юридический due diligence, потому что фокусируется на недобросовестных действиях, скрытых связях и операциях, которые не всегда видны в отчетности. Проверка отвечает на следующие вопросы:';
$auditQuestionsItems = [
    'есть ли признаки вывода активов или денежных средств',
    'есть ли сделки со связанными сторонами и скрытая аффилированность',
    'достоверны ли ключевые финансовые и управленческие показатели',
    'есть ли скрытые обязательства, спорные операции или нераскрытые риски',
    'какие контрагенты создают наибольший риск для сделки',
    'есть ли признаки фиктивной выручки, расходов или активов',
    'как выявленные риски могут повлиять на цену и условия сделки',
    'какие защитные условия нужно предусмотреть в документах',
];
...
$auditServiceTypesTitle = 'Что входит в форензик при сделках M&A';
$auditServiceTypesIntro = 'Объем проверки зависит от стадии сделки, доступности данных, размера бизнеса, отрасли и того, чью сторону сопровождаем: покупателя, продавца, инвестора или собственника.';
$auditServiceTypesLead = 'В работу могут входить:';
$auditServiceTypesItems = [
    'анализ финансовых данных и подозрительных операций',
    'проверка связанных сторон, контрагентов и бенефициарных связей',
    'выявление признаков вывода активов и скрытых обязательств',
    'оценка достоверности выручки, расходов, задолженности и активов',
    'проверка крупных сделок, займов, взаимозачетов и авансов',
    'анализ управленческой отчетности и расхождений с учетом',
    'подготовка отчета с рисками для сделки',
    'рекомендации по цене, условиям, гарантиям и защитным механизмам',
];

$auditProcessTitle = 'Как проводится форензик при сделках M&A';
...
$auditDeadlinesTitle = 'Сроки проведения услуги «Форензик при сделках (M&A)»';
...
$auditPricingTitle = 'Стоимость услуги «Форензик при сделках (M&A)»';
...
$auditDocumentsNeededTitle = 'Какие документы нужны для услуги «Форензик при сделках (M&A)»';
...
$auditDocumentsNeededItems = [
    'финансовая, бухгалтерская и управленческая отчетность',
    'банковские выписки, реестры платежей и оборотно-сальдовые ведомости',
    'договоры с ключевыми контрагентами, займы и взаимозачеты',
    'реестры дебиторской и кредиторской задолженности',
    'данные о связанных сторонах, собственниках и ключевых сотрудниках',
    'выгрузки из учетных, CRM, ERP и управленческих систем',
    'материалы юридического и финансового due diligence при наличии',
    'проект сделки, term sheet или перечень вопросов инвестора',
];
...
$auditResultsSummaryTitle = 'Что вы получите по итогам услуги «Форензик при сделках (M&A)»';
...
$auditMandatoryPrepTitle = 'Планируете сделку M&A? Поможем проверить скрытые риски';
$auditMandatoryPrepIntro = 'Перед сделкой важно увидеть не только официальные показатели, но и операции, которые могут изменить оценку бизнеса: связанные стороны, спорные платежи, скрытые долги и потенциальные злоупотребления.';
$auditMandatoryPrepLead = 'Мы помогаем определить:';
$auditMandatoryPrepItems = [
    'какие риски нужно проверить до подписания документов',
    'какие данные запросить у целевой компании',
    'какие операции могут повлиять на цену сделки',
    'какие гарантии и условия стоит включить в договор',
...
$auditFinalCtaTitle = 'Нужна услуга «Форензик при сделках (M&A)»? Начнем с оценки ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Форензик при сделках (M&A)»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Форензик при сделках (M&A)»?',
...
// ============================================================
// FILE: security-system-effectiveness.php
// ============================================================
...
<body class="has-site-header has-breadcrumbs page-forenzik-forenzik-pri-sdelkah-ma">
