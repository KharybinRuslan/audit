...
$pageTitle = 'Эффективная система безопасности';
$pageDescription = 'Эффективная система безопасности: оценка процессов, внутренних контролей, рисков мошенничества, защиты активов, информации, сделок и ответственности сотрудников.';

$serviceCoverHeroTitle = 'Эффективная система безопасности';
$serviceCoverHeroLead = 'Проверим, насколько система безопасности компании защищает бизнес от финансовых потерь, мошенничества, утечек, конфликта интересов, недобросовестных контрагентов и внутренних злоупотреблений. Поможем выстроить понятные контрольные процедуры, зоны ответственности и практичные правила защиты активов.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 5 рабочих дней',
    'Оценка рисков, процессов и контрольных процедур',
    'Рекомендации для защиты бизнеса',
];
$serviceCoverHeroNote = 'На первичной консультации определим ключевые риски бизнеса и участки, где безопасность требует усиления в первую очередь.';
$serviceCoverHeroBgUrl = '/img/audit/forenzik.webp';

$auditOrderReasonsTitle = 'В каких случаях заказывают оценку системы безопасности';
$auditOrderReasonsIntro = [
    'Оценка системы безопасности нужна, когда бизнес растет, меняются процессы, увеличиваются обороты, появляются новые подразделения или собственники хотят понять, насколько компания защищена от внутренних и внешних угроз.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'компания сталкивалась с мошенничеством, утечками или злоупотреблениями',
    'нет понятных процедур проверки контрагентов, сотрудников и сделок',
    'платежи, закупки или договоры согласуются формально',
    'руководство хочет снизить зависимость от отдельных сотрудников',
    'бизнес масштабируется и требует более зрелой системы контроля',
    'нужно подготовить регламенты, матрицы ответственности и контрольные процедуры',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает оценка системы безопасности';
$auditCheckResultsParagraphs = [
    'Оценка показывает, какие риски есть в текущих процессах, где отсутствуют контрольные точки, какие операции могут быть уязвимы для злоупотреблений и какие процедуры нужно внедрить или усилить.',
    'По итогам работы вы получаете отчет с картой рисков, перечнем слабых мест, практичными рекомендациями и приоритетным планом действий.',
];

$auditQuestionsTitle = 'Какие задачи решает построение эффективной системы безопасности';
$auditQuestionsIntro = 'Система безопасности должна не мешать бизнесу, а помогать управлять рисками. Работа помогает ответить на следующие вопросы:';
$auditQuestionsItems = [
    'какие процессы наиболее уязвимы для мошенничества и злоупотреблений',
    'достаточно ли контролей в закупках, платежах, продажах и договорах',
    'как проверяются контрагенты, сотрудники и крупные сделки',
    'кто отвечает за согласование и контроль ключевых операций',
    'какие регламенты отсутствуют или не работают на практике',
    'где есть риск конфликта интересов или обхода процедур',
    'какие меры можно внедрить быстро и без перегрузки сотрудников',
    'как контролировать исполнение новых процедур',
];
...
$auditServiceTypesTitle = 'Что входит в работу по системе безопасности';
$auditServiceTypesIntro = 'Формат работы зависит от размера компании, отрасли, уровня зрелости процессов и уже существующих контрольных процедур.';
$auditServiceTypesLead = 'В работу могут входить:';
$auditServiceTypesItems = [
    'оценка текущих бизнес-процессов и контрольных точек',
    'анализ рисков мошенничества, утечек и злоупотреблений',
    'проверка процедур согласования платежей, договоров и закупок',
    'оценка проверки контрагентов и сотрудников',
    'разработка матрицы полномочий и ответственности',
    'подготовка регламентов, чек-листов и контрольных процедур',
    'рекомендации по мониторингу рисковых операций',
    'сопровождение внедрения изменений',
];

$auditProcessTitle = 'Как проводится оценка и настройка системы безопасности';
...
$auditDeadlinesTitle = 'Сроки проведения услуги «Эффективная система безопасности»';
...
$auditPricingTitle = 'Стоимость услуги «Эффективная система безопасности»';
...
$auditDocumentsNeededTitle = 'Какие документы нужны для услуги «Эффективная система безопасности»';
...
$auditDocumentsNeededItems = [
    'описание бизнес-процессов и организационная структура',
    'регламенты закупок, платежей, договорной работы и согласований',
    'матрицы полномочий, лимиты и роли пользователей',
    'примеры договоров, заявок, платежей и согласований',
    'политики проверки контрагентов и сотрудников',
    'данные о прошлых инцидентах, нарушениях или потерях',
    'выгрузки из учетных, ERP, CRM или банковских систем',
    'действующие политики информационной и экономической безопасности',
];
...
$auditResultsSummaryTitle = 'Что вы получите по итогам услуги «Эффективная система безопасности»';
...
$auditMandatoryPrepTitle = 'Хотите усилить безопасность бизнеса? Поможем выстроить рабочую систему';
$auditMandatoryPrepIntro = 'Эффективная безопасность начинается не с формальных регламентов, а с понимания реальных рисков: где компания теряет деньги, где процессы можно обойти и какие решения зависят от одного человека.';
$auditMandatoryPrepLead = 'Мы помогаем определить:';
$auditMandatoryPrepItems = [
    'какие процессы проверить в первую очередь',
    'какие контроли уже работают, а какие существуют только на бумаге',
    'какие регламенты и чек-листы нужны бизнесу',
    'как распределить ответственность между подразделениями',
    'как внедрить контроль без бюрократии и лишней нагрузки',
];
...
$auditFinalCtaTitle = 'Нужна услуга «Эффективная система безопасности»? Начнем с оценки ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Эффективная система безопасности»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Эффективная система безопасности»?',
...
// ============================================================
// FILE: suspicious-transactions-analysis.php
// ============================================================
...
<body class="has-site-header has-breadcrumbs page-forenzik-effektivnaya-sistema-bezopasnosti">
