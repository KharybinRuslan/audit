...
$pageTitle = 'Проверка сотрудников (fraud check)';
$pageDescription = 'Проверка сотрудников fraud check: оценка рисков злоупотреблений, конфликта интересов, недостоверных данных, связей с контрагентами и нарушений корпоративных правил.';

$serviceCoverHeroTitle = 'Проверка сотрудников (fraud check)';
$serviceCoverHeroLead = 'Проведем проверку сотрудников или кандидатов на позиции с финансовой, закупочной, управленческой или информационной ответственностью. Оценим риски конфликта интересов, связей с контрагентами, недостоверных сведений, злоупотреблений, утечек и нарушений корпоративных правил.';
...
$serviceCoverHeroNote = 'Проверка проводится в правовом и этичном формате: анализируем только релевантные для бизнеса риски и доступные законные источники информации.';
$serviceCoverHeroBgUrl = '/img/audit/forenzik.webp';

$auditOrderReasonsTitle = 'В каких случаях заказывают проверку сотрудников';
$auditOrderReasonsIntro = [
    'Fraud check нужен, когда сотрудник или кандидат будет иметь доступ к деньгам, клиентской базе, коммерческой тайне, закупкам, платежам, договорам, складу, управленческим решениям или критичным системам компании.',
    'Чаще всего проверку проводят в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'кандидат претендует на должность с доступом к деньгам или важной информации',
    'сотрудник переводится на позицию с расширенными полномочиями',
    'есть подозрение на конфликт интересов или связь с контрагентами',
    'обнаружены признаки злоупотреблений, утечки или нарушения процедур',
    'компания проводит внутреннее расследование',
    'нужно снизить риски при найме, ротации или увольнении ключевых сотрудников',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает проверка сотрудников';
$auditCheckResultsParagraphs = [
    'Проверка показывает, есть ли у сотрудника или кандидата факторы риска, которые могут повлиять на безопасность бизнеса: конфликт интересов, связь с контрагентами, сомнительные обстоятельства, несоответствие данных или признаки возможных злоупотреблений.',
    'По итогам вы получаете отчет с выявленными рисками, подтверждающими материалами и рекомендациями по управленческим, кадровым или контрольным действиям.',
];

$auditQuestionsTitle = 'Какие задачи решает проверка сотрудников';
$auditQuestionsIntro = 'Проверка помогает компании принимать решения по найму, доступам и полномочиям на основе фактов. Обычно она отвечает на следующие вопросы:';
$auditQuestionsItems = [
    'есть ли признаки конфликта интересов',
    'связан ли сотрудник с поставщиками, подрядчиками или конкурентами',
    'соответствуют ли предоставленные сведения доступной информации',
    'есть ли риски для доступа к деньгам, данным или активам',
    'нужно ли ограничить или пересмотреть полномочия',
    'какие контрольные процедуры стоит применить',
    'есть ли основания для дополнительной внутренней проверки',
    'как снизить риски при найме, переводе или увольнении',
];
...
$auditServiceTypesTitle = 'Что входит в проверку сотрудников';
$auditServiceTypesIntro = 'Состав проверки зависит от должности, уровня доступа, отрасли, внутренних политик компании и цели: найм, перевод, расследование или увольнение.';
$auditServiceTypesLead = 'В проверку могут входить:';
$auditServiceTypesItems = [
    'анализ резюме, анкетных данных и предоставленных сведений',
    'проверка возможных связей с контрагентами и конкурентами',
    'оценка риска конфликта интересов',
    'анализ должностных полномочий и доступов',
    'проверка участия в спорных операциях или инцидентах',
    'изучение открытых и законно доступных источников',
    'подготовка отчета с уровнем риска',
    'рекомендации по доступам, контролям и кадровым решениям',
];

$auditProcessTitle = 'Как проводится проверка сотрудников';
...
$auditDeadlinesTitle = 'Сроки проведения услуги «Проверка сотрудников (fraud check)»';
...
$auditPricingTitle = 'Стоимость услуги «Проверка сотрудников (fraud check)»';
...
$auditDocumentsNeededTitle = 'Какие документы нужны для услуги «Проверка сотрудников (fraud check)»';
...
$auditDocumentsNeededItems = [
    'ФИО сотрудника или кандидата и базовые идентификационные данные',
    'резюме, анкета или сведения, предоставленные кандидатом',
    'должность, зона ответственности и уровень доступа',
    'должностная инструкция и полномочия',
    'перечень систем, данных и активов, к которым есть доступ',
    'информация о контрагентах, с которыми взаимодействует сотрудник',
    'материалы внутреннего инцидента при необходимости',
    'внутренние политики проверки персонала и обработки данных',
];
...
$auditResultsSummaryTitle = 'Что вы получите по итогам услуги «Проверка сотрудников (fraud check)»';
...
$auditMandatoryPrepTitle = 'Нужно проверить сотрудника или кандидата? Поможем оценить риски';
$auditMandatoryPrepIntro = 'Проверка сотрудников должна быть пропорциональной и законной. Важно заранее определить, какие риски релевантны должности и какие источники информации допустимо использовать.';
$auditMandatoryPrepLead = 'Мы помогаем определить:';
$auditMandatoryPrepItems = [
    'какой объем проверки нужен для конкретной должности',
    'какие данные можно анализировать законно и корректно',
    'какие риски критичны для бизнеса',
    'как оформить выводы для HR, службы безопасности или руководства',
    'какие меры контроля применить без нарушения прав сотрудника',
];
...
$auditFinalCtaTitle = 'Нужна услуга «Проверка сотрудников (fraud check)»? Начнем с оценки ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Проверка сотрудников (fraud check)»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Проверка сотрудников (fraud check)»?',
...
// ============================================================
// FILE: financial-fraud-investigation.php
// ============================================================
...
<body class="has-site-header has-breadcrumbs page-forenzik-proverka-sotrudnikov-fraud-check">
