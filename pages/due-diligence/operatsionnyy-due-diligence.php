...
$pageTitle = 'Операционный Due Diligence';
$pageDescription = 'Операционный Due Diligence: проверка бизнес-процессов, операционной модели, ресурсов, персонала, поставщиков, клиентов, эффективности и рисков.';

$serviceCoverHeroTitle = 'Операционный Due Diligence';
$serviceCoverHeroLead = 'Проведем операционный Due Diligence компании, проекта или актива перед сделкой, инвестированием или масштабированием. Проверим бизнес-процессы, операционную модель, ресурсы, персонал, поставщиков, клиентов, производственные и управленческие процессы, эффективность и риски дальнейшей работы.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 7 рабочих дней',
    'Процессы, ресурсы, команда, клиенты, поставщики и риски',
...
$auditOrderReasonsTitle = 'Когда нужен Операционный Due Diligence';
...
$auditOrderReasonsItems = [
    'инвестор оценивает операционную устойчивость бизнеса',
    'покупатель хочет понять, как компания работает изнутри',
    'нужно проверить зависимость от ключевых сотрудников, клиентов или поставщиков',
    'есть сомнения в эффективности процессов',
    'планируется интеграция бизнеса после сделки',
    'требуется оценить операционные риски перед масштабированием',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Операционный Due Diligence показывает';
$auditCheckResultsParagraphs = [
    'Операционный Due Diligence показывает, насколько фактическая работа компании соответствует заявленной бизнес-модели, где есть слабые места, операционные потери, зависимость от людей, неформальные процессы, риски с поставщиками, клиентами или ресурсами.',
    'По итогам вы получаете отчет с операционными рисками, оценкой процессов и рекомендациями по дальнейшему управлению бизнесом.',
];

$auditQuestionsTitle = 'Какие задачи решает услуга «Операционный Due Diligence»';
...
$auditQuestionsItems = [
    ...
    'выявить зависимость от ключевых сотрудников',
    'проверить операционную модель компании',
    'оценить риски по поставщикам и клиентам',
    'найти узкие места и скрытые потери',
    'оценить готовность бизнеса к масштабированию',
    'понять риски интеграции после сделки',
...
$auditServiceTypesTitle = 'экспресс-операционная диагностика';
...
$auditServiceTypesItems = [
    'экспресс-операционная диагностика',
    'полный операционный Due Diligence',
    'анализ бизнес-процессов',
    'проверка операционной модели',
    'оценка команды и зон ответственности',
    'анализ поставщиков и клиентов',
    'оценка готовности к масштабированию',
    'операционный отчет для инвестора или покупателя',
];

$auditProcessTitle = 'Как проводится услуга «Операционный Due Diligence»';
...
$auditProcessSteps = [
    ...
    [
        'number' => '03',
        'title' => 'Проверка по направлению «операционный»',
...
$auditDocumentsNeededItems = [
    ...
    'регламенты и описания процессов',
    'управленческая отчетность',
    'данные по клиентам и поставщикам',
    'сведения о персонале и ключевых сотрудниках',
    'показатели эффективности процессов',
    'информация о производстве, логистике, продажах или сервисе',
];
...
$auditResultsSummaryItems = [
    'отчет по операционному Due Diligence',
    'оценку бизнес-процессов и операционной модели',
    'перечень операционных рисков',
    'анализ зависимости от сотрудников, клиентов и поставщиков',
    'выводы по эффективности процессов',
    'рекомендации по интеграции или масштабированию',
    'план первоочередных улучшений',
];
...
$auditMandatoryPrepItems = [
    'какие процессы нужно проверить',
    'где могут быть ключевые зависимости',
    'какие операционные риски влияют на цену',
    'что важно проверить до интеграции',
    'какие улучшения понадобятся после сделки',
];
...
$auditFinalCtaTitle = 'Нужен Операционный Due Diligence?';
...
$auditFaqTitle = 'Частые вопросы по услуге «Операционный Due Diligence»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Операционный Due Diligence»?',
    ...
    [
        ...
        'a' => 'Обычно нужны описание бизнес-модели компании, организационная структура, регламенты и описания процессов, управленческая отчетность, данные по клиентам и поставщикам. Полный перечень уточняется после первичной оценки задачи.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите отчет по операционному Due Diligence, выводы, рекомендации и перечень дальнейших действий.',
    ],
];
...
<body class="has-site-header has-breadcrumbs page-due-diligence-operatsionnyy-due-diligence">
