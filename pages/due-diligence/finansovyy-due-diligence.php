...
$pageTitle = 'Финансовый Due Diligence';
$pageDescription = 'Финансовый Due Diligence: проверка отчетности, выручки, расходов, долгов, активов, денежных потоков, EBITDA и финансовых рисков сделки.';

$serviceCoverHeroTitle = 'Финансовый Due Diligence';
$serviceCoverHeroLead = 'Проведем финансовый Due Diligence компании, проекта или актива перед сделкой, покупкой доли, привлечением инвестиций или кредитованием. Проверим отчетность, выручку, расходы, активы, обязательства, денежные потоки, задолженность, качество прибыли и финансовые риски, которые могут повлиять на цену и условия сделки.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 5 рабочих дней',
    'Отчетность, долги, EBITDA, денежные потоки и риски',
...
$auditOrderReasonsTitle = 'Когда нужен Финансовый Due Diligence';
...
$auditOrderReasonsItems = [
    ...
    'инвестор оценивает проект перед вложением средств',
    'нужно подтвердить выручку, прибыль и денежные потоки',
    'есть сомнения в корректности управленческой или бухгалтерской отчетности',
    'требуется выявить скрытые долги и обязательства',
    'нужно оценить финансовые риски перед подписанием сделки',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Финансовый Due Diligence показывает';
$auditCheckResultsParagraphs = [
    'Финансовый Due Diligence показывает, насколько отчетность отражает реальное состояние бизнеса, есть ли завышение выручки, занижение расходов, скрытые обязательства, проблемная дебиторская задолженность или зависимость прибыли от разовых факторов.',
    'По итогам работы вы получаете независимый отчет с выводами о финансовом состоянии компании, ключевых рисках и вопросах, которые нужно учесть в сделке.',
];

$auditQuestionsTitle = 'Какие задачи решает услуга «Финансовый Due Diligence»';
...
$auditQuestionsItems = [
    'проверить достоверность финансовой отчетности',
    'оценить качество выручки и прибыли',
    'выявить скрытые долги и обязательства',
    'проанализировать дебиторскую и кредиторскую задолженность',
    'оценить денежные потоки и ликвидность',
    'проверить активы и запасы',
    'оценить EBITDA и нормализованные показатели',
    'подготовить финансовые выводы для сделки',
];
...
$auditServiceTypesTitle = 'экспресс-финансовая проверка';
...
$auditServiceTypesItems = [
    'экспресс-финансовая проверка',
    'полный финансовый Due Diligence',
    'анализ качества выручки и прибыли',
    'проверка задолженности и обязательств',
    'анализ денежных потоков',
    'проверка управленческой отчетности',
    'оценка финансовой модели сделки',
    'подготовка финансового отчета для инвестора или покупателя',
];

$auditProcessTitle = 'Как проводится услуга «Финансовый Due Diligence»';
...
$auditProcessSteps = [
    ...
    [
        'number' => '03',
        'title' => 'Проверка по направлению «финансовый»',
...
$auditDocumentsNeededItems = [
    ...
    'расшифровки выручки, расходов и прибыли',
    'данные по дебиторской и кредиторской задолженности',
    'банковские выписки и данные по денежным потокам',
    'информация об активах, запасах, кредитах и обязательствах',
];
...
$auditResultsSummaryItems = [
    ...
    'оценку достоверности финансовых показателей',
    'анализ выручки, расходов и прибыли',
    'оценку долгов, активов и обязательств',
    'перечень финансовых рисков сделки',
    'рекомендации по цене, условиям и дополнительным запросам',
    'независимую позицию для инвестора, покупателя или собственника',
];
...
$auditMandatoryPrepItems = [
    'какие финансовые данные запросить у продавца',
    'какие показатели требуют проверки в первую очередь',
    'какие риски могут повлиять на цену сделки',
    'какие вопросы нужно вынести на переговоры',
    'какой формат отчета подойдет для принятия решения',
];
...
$auditFinalCtaTitle = 'Нужен Финансовый Due Diligence?';
...
$auditFaqTitle = 'Частые вопросы по услуге «Финансовый Due Diligence»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Финансовый Due Diligence»?',
    ...
    [
        ...
        'a' => 'Обычно нужны бухгалтерская отчетность за проверяемый период, управленческая отчетность, налоговые декларации и расчеты, оборотно-сальдовые ведомости, расшифровки выручки, расходов и прибыли. Полный перечень уточняется после первичной оценки задачи.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите отчет по финансовому Due Diligence, выводы, рекомендации и перечень дальнейших действий.',
    ],
];
...
<body class="has-site-header has-breadcrumbs page-due-diligence-finansovyy-due-diligence">
