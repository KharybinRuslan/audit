...
$pageTitle = 'Аутсорсинг иностранной компании';

$pageDescription = 'Аутсорсинг иностранной компании ООО "Аудит Топ Эксперт": бухгалтерское, налоговое и кадровое сопровождение иностранного бизнеса в России.';

$serviceCoverHeroTitle = 'Аутсорсинг для иностранной компании';

$serviceCoverHeroLead = 'Организуем бухгалтерское, налоговое и кадровое сопровождение иностранной компании, представительства, филиала или российского юридического лица с иностранным участием. Поможем вести учет, готовить отчетность, контролировать документы, расчеты и требования локального учета.';

$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок запуска — от 5 рабочих дней',
    'Бухгалтерский, налоговый и кадровый аутсорсинг',
    'Работаем с иностранными компаниями и группами',
];

$serviceCoverHeroNote = 'Оценим структуру бизнеса, локальные требования, документооборот и задачи головного офиса, после чего предложим формат сопровождения.';

$serviceCoverHeroBgUrl = '/img/audit/buxgalteria.webp';

$auditOrderReasonsTitle = 'Когда нужен аутсорсинг иностранной компании';

$auditOrderReasonsIntro = [
    'Аутсорсинг иностранной компании нужен, когда компании важно обеспечить порядок в документах, снизить операционные и налоговые риски, разгрузить команду и получить регулярную экспертную поддержку.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];

$auditOrderReasonsItems = [
    'иностранная компания начинает деятельность в России',
    'у бизнеса есть филиал, представительство или дочерняя структура',
    'нужна локальная бухгалтерия и отчетность',
    'головному офису требуется понятная регулярная информация',
    'возникают вопросы по документам, валютным операциям и налогам',
    'нужно снизить нагрузку на внутреннюю команду и управлять локальными рисками',
];

$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает аутсорсинг иностранной компании';

$auditCheckResultsParagraphs = [
    'Аутсорсинг иностранной компании показывает, насколько корректно организованы процессы, документы, ответственность, сроки и контрольные точки по выбранному направлению.',
...
$auditQuestionsTitle = 'Какие задачи решает аутсорсинг иностранной компании';

$auditQuestionsIntro = 'Перечень задач зависит от структуры компании, количества операций и текущего состояния процессов, но чаще всего аутсорсинг иностранной компании помогает ответить на следующие вопросы:';

$auditQuestionsItems = [
    'какие требования локального учета нужно соблюдать',
    'как организовать документооборот с головным офисом',
    'какие отчеты нужны для менеджмента и локальных органов',
    'как вести расчеты с контрагентами и сотрудниками',
    'какие налоговые и бухгалтерские риски требуют контроля',
    'как согласовать локальный учет с корпоративными требованиями',
    'какие процессы лучше передать на аутсорсинг',
    'как обеспечить регулярную коммуникацию с иностранной командой',
];

$auditQuestionsOutro = 'Если говорить простыми словами, аутсорсинг иностранной компании помогает убрать хаос из текущих процессов и сделать работу более контролируемой для руководителя и команды.';

$auditServiceTypesTitle = 'Форматы услуги «Аутсорсинг иностранной компании»';
...
$auditServiceTypesItems = [
    'бухгалтерское сопровождение иностранной компании',
    'налоговое сопровождение и отчетность',
    'кадровое делопроизводство и payroll',
    'подготовка управленческих отчетов для головного офиса',
    'контроль первичных документов и договоров',
    'сопровождение валютных и внешнеэкономических операций',
    'консультации по локальному учету',
    'комплексный аутсорсинг функций back office',
];

$auditProcessTitle = 'Как организуется аутсорсинг иностранной компании';
...
$auditDocumentsNeededItems = [
    'учредительные документы локальной структуры',
    'сведения о группе компаний и головном офисе',
    'бухгалтерская и налоговая отчетность, если уже ведется',
    'договоры с контрагентами и сотрудниками',
    'банковские выписки и платежные документы',
    'документы по ВЭД и валютным операциям',
    'корпоративные требования к отчетности',
    'описание текущих процессов и задач',
];
...
$auditResultsSummaryItems = [
    'локальное бухгалтерское и налоговое сопровождение',
    'контроль отчетности и сроков',
    'понятный документооборот с головным офисом',
    'подготовку отчетов для менеджмента',
    'снижение рисков по локальному учету',
    'сопровождение кадровых и расчетных процессов',
    'регулярную коммуникацию с ответственными лицами',
];

$auditResultsSummaryOutro = 'Аутсорсинг иностранной компании помогает компании работать стабильнее, быстрее закрывать текущие вопросы и снижать риски, связанные с документами, сроками и человеческим фактором.';

$auditPrepTitle = 'Нужен аутсорсинг иностранной компании? Начнем с диагностики';
...
$auditPrepItems = [
    'какая структура бизнеса используется',
    'какие отчеты нужны головному офису',
    'какие локальные процессы уже настроены',
    'какие документы и доступы нужны для старта',
    'какие риски требуют первичной проверки',
];
...
$auditFinalCtaTitle = 'Нужен аутсорсинг иностранной компании? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы: аутсорсинг иностранной компании';

$auditFaqItems = [
    [
        'q' => 'Что входит в аутсорсинга иностранной компании?',
...
<body class="has-site-header has-breadcrumbs page-buhgalteriya-autsorsing-inostrannoy-kompanii">
