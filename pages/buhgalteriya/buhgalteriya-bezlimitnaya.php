...
$pageTitle = 'Бухгалтерия Безлимитная';

$pageDescription = 'Бухгалтерия Безлимитная ООО "Аудит Топ Эксперт": регулярное бухгалтерское сопровождение, консультации, отчетность и контроль учета в удобном формате.';

$serviceCoverHeroTitle = 'Бухгалтерия Безлимитная для стабильного учета';

$serviceCoverHeroLead = 'Организуем регулярное бухгалтерское сопровождение в формате постоянной поддержки: учет, отчетность, консультации, контроль документов и помощь по текущим вопросам. Такой формат подходит бизнесу, которому важно быстро получать ответы и не ограничиваться разовыми обращениями.';

$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок запуска — от 3 рабочих дней',
    'Регулярная поддержка бухгалтера и контроль учета',
    'Работаем с компаниями по всей России',
];

$serviceCoverHeroNote = 'Оценим объем операций, документооборот и задачи, после чего предложим состав безлимитного сопровождения под ваш бизнес.';

$serviceCoverHeroBgUrl = '/img/audit/buxgalteria.webp';

$auditOrderReasonsTitle = 'Когда нужен бухгалтерия безлимитная';

$auditOrderReasonsIntro = [
    'Бухгалтерия Безлимитная нужен, когда компании важно обеспечить порядок в документах, снизить операционные и налоговые риски, разгрузить команду и получить регулярную экспертную поддержку.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];

$auditOrderReasonsItems = [
    'руководителю нужна постоянная бухгалтерская поддержка',
    'в компании много текущих вопросов по документам и налогам',
    'штатный бухгалтер не закрывает все задачи бизнеса',
    'важно получать консультации без долгого ожидания',
    'нужно регулярно контролировать отчетность, платежи и документы',
    'компания хочет заменить разовые обращения системным сопровождением',
];

$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает бухгалтерия безлимитная';

$auditCheckResultsParagraphs = [
    'Бухгалтерия Безлимитная показывает, насколько корректно организованы процессы, документы, ответственность, сроки и контрольные точки по выбранному направлению.',
...
$auditQuestionsTitle = 'Какие задачи решает бухгалтерия безлимитная';

$auditQuestionsIntro = 'Перечень задач зависит от структуры компании, количества операций и текущего состояния процессов, но чаще всего бухгалтерское сопровождение помогает ответить на следующие вопросы:';

$auditQuestionsItems = [
    'какие бухгалтерские задачи можно передать на постоянную поддержку',
    'как быстро получать ответы по текущим вопросам',
    'какие документы нужно контролировать каждый месяц',
    'как не пропускать отчетные даты и налоговые платежи',
    'какие ошибки повторяются в учете',
    'как распределить задачи между бизнесом и бухгалтером',
    'какие процессы можно стандартизировать',
    'как сделать бухгалтерию понятной для руководителя',
];

$auditQuestionsOutro = 'Если говорить простыми словами, бухгалтерское сопровождение помогает убрать хаос из текущих процессов и сделать работу более контролируемой для руководителя и команды.';

$auditServiceTypesTitle = 'Форматы услуги «Бухгалтерия Безлимитная»';
...
$auditServiceTypesItems = [
    'регулярные консультации бухгалтера',
    'контроль первичных документов',
    'подготовка и сопровождение отчетности',
    'проверка текущих операций',
    'помощь по налоговым и учетным вопросам',
    'сопровождение расчетов с контрагентами',
    'поддержка руководителя и сотрудников',
    'постановка регулярного документооборота',
];

$auditProcessTitle = 'Как организуется бухгалтерия безлимитная';
...
$auditDocumentsNeededItems = [
    'данные о компании и системе налогообложения',
    'бухгалтерская база или выгрузки',
    'первичные документы за текущий период',
    'договоры и счета',
    'банковские выписки',
    'сведения о сотрудниках и зарплате',
    'отчетность за прошлые периоды',
    'список текущих вопросов и задач',
];
...
$auditResultsSummaryItems = [
    'регулярную бухгалтерскую поддержку',
    'контроль документов и отчетности',
    'быстрые ответы на текущие вопросы',
    'снижение риска пропущенных сроков',
    'понятный порядок взаимодействия',
    'рекомендации по улучшению учета',
    'поддержку бизнеса без разовых хаотичных обращений',
];

$auditResultsSummaryOutro = 'Бухгалтерия Безлимитная помогает компании работать стабильнее, быстрее закрывать текущие вопросы и снижать риски, связанные с документами, сроками и человеческим фактором.';

$auditPrepTitle = 'Нужен бухгалтерия безлимитная? Начнем с диагностики';
...
$auditPrepItems = [
    'какие задачи должны входить в сопровождение',
    'какой объем операций у компании',
    'какие вопросы возникают чаще всего',
    'какие сроки отчетности нужно контролировать',
    'как удобнее передавать документы и задачи',
];
...
$auditFinalCtaTitle = 'Нужен бухгалтерия безлимитная? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы: бухгалтерия безлимитная';

$auditFaqItems = [
    [
        'q' => 'Что входит в безлимитной бухгалтерии?',
...
<body class="has-site-header has-breadcrumbs page-buhgalteriya-buhgalteriya-bezlimitnaya">
