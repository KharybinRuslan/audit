...
$pageTitle = 'Аутсорсинг на время декрета Главбуха';

$pageDescription = 'Аутсорсинг на время декрета главного бухгалтера ООО "Аудит Топ Эксперт": временное сопровождение учета, отчетности, налогов и бухгалтерских процессов.';

$serviceCoverHeroTitle = 'Аутсорсинг бухгалтерии на время декрета главного бухгалтера';

$serviceCoverHeroLead = 'Подменим главного бухгалтера на период декрета, отпуска или длительного отсутствия: обеспечим контроль учета, отчетности, налоговых сроков, документов и текущих бухгалтерских процессов. Поможем бизнесу пройти переходный период без остановки работы и потери контроля.';

$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Запуск — от 3 рабочих дней',
    'Временная замена главного бухгалтера',
    'Работаем с компаниями по всей России',
];

$serviceCoverHeroNote = 'Оценим текущие обязанности главного бухгалтера, состояние учета и критичные сроки, после чего предложим формат временного сопровождения.';

$serviceCoverHeroBgUrl = '/img/audit/buxgalteria.webp';

$auditOrderReasonsTitle = 'Когда нужен аутсорсинг на время декрета главбуха';

$auditOrderReasonsIntro = [
    'Аутсорсинг на время декрета Главбуха нужен, когда компании важно обеспечить порядок в документах, снизить операционные и налоговые риски, разгрузить команду и получить регулярную экспертную поддержку.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];

$auditOrderReasonsItems = [
    'главный бухгалтер уходит в декрет, отпуск или на больничный',
    'нужно сохранить контроль отчетности и налоговых сроков',
    'компания не успевает быстро найти замену в штат',
    'важно передать дела без потери информации',
    'нужен внешний специалист для контроля бухгалтерии',
    'руководитель хочет снизить зависимость от одного сотрудника',
];

$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает аутсорсинг на время декрета главбуха';

$auditCheckResultsParagraphs = [
    'Аутсорсинг на время декрета Главбуха показывает, насколько корректно организованы процессы, документы, ответственность, сроки и контрольные точки по выбранному направлению.',
...
$auditQuestionsTitle = 'Какие задачи решает аутсорсинг на время декрета главбуха';

$auditQuestionsIntro = 'Перечень задач зависит от структуры компании, количества операций и текущего состояния процессов, но чаще всего временное бухгалтерское сопровождение помогает ответить на следующие вопросы:';

$auditQuestionsItems = [
    'какие обязанности главного бухгалтера нужно временно закрыть',
    'какие отчетные даты и платежи критичны в ближайший период',
    'в каком состоянии учет передается на сопровождение',
    'какие документы и доступы нужны для безопасной передачи дел',
    'как организовать коммуникацию с руководством и сотрудниками',
    'какие риски есть по прошлым периодам',
    'как контролировать работу штатных бухгалтеров',
    'как вернуть процессы после выхода сотрудника',
];

$auditQuestionsOutro = 'Если говорить простыми словами, временное бухгалтерское сопровождение помогает убрать хаос из текущих процессов и сделать работу более контролируемой для руководителя и команды.';

$auditServiceTypesTitle = 'Форматы услуги «Аутсорсинг на время декрета Главбуха»';
...
$auditServiceTypesItems = [
    'временное исполнение функций главного бухгалтера',
    'контроль бухгалтерской и налоговой отчетности',
    'сопровождение закрытия периода',
    'контроль налогов и обязательных платежей',
    'проверка первичных документов и операций',
    'консультации руководителя и бухгалтерии',
    'передача дел и описание процессов',
    'сопровождение до выхода штатного сотрудника',
];

$auditProcessTitle = 'Как организуется аутсорсинг на время декрета главбуха';
...
$auditDocumentsNeededItems = [
    ...
    'доступная отчетность и учетная база',
    'календарь отчетных сроков',
    'первичные документы и банковские выписки',
    'договоры и расчеты с контрагентами',
    'сведения о сотрудниках и зарплате',
    'информация о текущих проблемах учета',
...
$auditResultsSummaryItems = [
    'временное закрытие функций главного бухгалтера',
    'контроль отчетности, налогов и сроков',
    'сохранение непрерывности бухгалтерских процессов',
    'проверку ключевых участков учета',
    'рекомендации по передаче дел',
    'поддержку руководителя в бухгалтерских вопросах',
    'снижение риска ошибок в переходный период',
];

$auditResultsSummaryOutro = 'Аутсорсинг на время декрета Главбуха помогает компании работать стабильнее, быстрее закрывать текущие вопросы и снижать риски, связанные с документами, сроками и человеческим фактором.';

$auditPrepTitle = 'Нужен аутсорсинг на время декрета главбуха? Начнем с диагностики';
...
$auditPrepItems = [
    'какие функции главбуха нужно закрыть',
    'какие сроки и отчеты ближайшие',
    'какие доступы и документы нужны',
    'какие участки учета требуют контроля',
    'как организовать передачу дел без хаоса',
];
...
$auditFinalCtaTitle = 'Нужен аутсорсинг на время декрета главбуха? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы: аутсорсинг на время декрета главбуха';

$auditFaqItems = [
    [
        'q' => 'Что входит в аутсорсинга на время декрета главбуха?',
...
<body class="has-site-header has-breadcrumbs page-buhgalteriya-autsorsing-dekret-glavbuh">
