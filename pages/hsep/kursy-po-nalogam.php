...
$pageTitle = 'Курсы по налогам';
$pageDescription = 'Курсы по налогам: обучение, практика, материалы, кейсы и повышение квалификации для специалистов и корпоративных команд.';

$serviceCoverHeroTitle = 'Курсы по налогам';
$serviceCoverHeroLead = 'Практические курсы по налогам для бухгалтеров, финансовых специалистов, руководителей и предпринимателей. Разбираем налоговый учет, требования ФНС, налоговые риски, проверки, НДС, налог на прибыль, УСН, документальное подтверждение расходов и спорные ситуации.';
...
$auditOrderReasonsTitle = 'Когда нужно обучение по направлению «Курсы по налогам»';
$auditOrderReasonsIntro = [
    'Обучение по направлению «Курсы по налогам» нужно, если нужно разобраться в налоговых рисках, повысить качество налогового учета, подготовиться к требованиям ФНС или обучить команду безопасной работе с налогами.',
...
$auditServiceTypesItems = [
    ...
    'НДС, прибыль, УСН и зарплатные налоги',
    'требования и проверки ФНС',
    'налоговые риски сделок',
    'документальное подтверждение расходов',
    'ответы на требования налогового органа',
    'налоговая безопасность бизнеса',
    'практические кейсы по налогам',
];

$auditProcessTitle = 'Как проходит обучение по направлению «Курсы по налогам»';
...
$auditProcessSteps = [
    [
        ...
        'text' => 'Вы описываете задачу, уровень подготовки участников и желаемый результат. Мы определяем, какой формат обучения по направлению «Курсы по налогам» подойдет лучше всего.',
    ],
    [
        'number' => '02',
        'title' => 'Определение программы',
        'text' => 'Согласуем темы, продолжительность, глубину разбора, практические задания и акценты: налоги, ФНС, риски, документы, проверки, НДС, прибыль, УСН и практические кейсы.',
    ],
    [
        'number' => '03',
...
$auditFinalCtaTitle = 'Нужно обучение по направлению «Курсы по налогам»?';
...
$auditFaqTitle = 'Частые вопросы по обучению «Курсы по налогам»';
$auditFaqItems = [
    [
        'q' => 'Кому подойдет обучение «Курсы по налогам»?',
        'a' => 'Обучение подойдет бухгалтерам, главным бухгалтерам, финансистам, юристам, руководителям и предпринимателям, которым важно понимать налоговые риски и порядок работы с ФНС.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-hsep-kursy-po-nalogam">
