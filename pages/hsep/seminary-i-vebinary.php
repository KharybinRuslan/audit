...
$pageTitle = 'Семинары и вебинары';
$pageDescription = 'Семинары и вебинары: обучение, практика, материалы, кейсы и повышение квалификации для специалистов и корпоративных команд.';

$serviceCoverHeroTitle = 'Семинары и вебинары';
$serviceCoverHeroLead = 'Проводим семинары и вебинары по бухгалтерии, налогам, финансам, МСФО, внутреннему аудиту, комплаенсу, управленческому учету и смежным темам. Формат подходит для быстрого разбора изменений, практических ошибок, актуальной темы или вопросов команды.';
...
$auditOrderReasonsTitle = 'Когда нужно обучение по направлению «Семинары и вебинары»';
$auditOrderReasonsIntro = [
    'Обучение по направлению «Семинары и вебинары» нужно, если важно быстро разобрать конкретную тему, изменения, практическую проблему или набор вопросов без запуска длинного курса.',
...
$auditServiceTypesItems = [
    'разовые вебинары по актуальным темам',
    'очные и онлайн-семинары',
    'практические интенсивы',
    'Q&A-сессии с экспертами',
    'разбор изменений и практики',
    'семинары по бухгалтерии и налогам',
    'вебинары по финансам, МСФО и аудиту',
    'корпоративные мероприятия под запрос компании',
];

$auditProcessTitle = 'Как проходит обучение по направлению «Семинары и вебинары»';
...
$auditProcessSteps = [
    [
        ...
        'text' => 'Вы описываете задачу, уровень подготовки участников и желаемый результат. Мы определяем, какой формат обучения по направлению «Семинары и вебинары» подойдет лучше всего.',
    ],
    [
        'number' => '02',
        'title' => 'Определение программы',
        'text' => 'Согласуем темы, продолжительность, глубину разбора, практические задания и акценты: актуальная тема, практические кейсы, изменения, вопросы участников и формат выступления.',
    ],
    [
        'number' => '03',
...
$auditFinalCtaTitle = 'Нужно обучение по направлению «Семинары и вебинары»?';
...
$auditFaqTitle = 'Частые вопросы по обучению «Семинары и вебинары»';
$auditFaqItems = [
    [
        'q' => 'Кому подойдет обучение «Семинары и вебинары»?',
        'a' => 'Обучение подойдет бухгалтерам, финансистам, аудиторам, юристам, HR-специалистам, руководителям и корпоративным командам, которым нужно быстро разобрать конкретную тему.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-hsep-seminary-i-vebinary">
