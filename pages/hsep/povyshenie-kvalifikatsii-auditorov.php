...
$pageTitle = 'Повышение квалификации аудиторов';
$pageDescription = 'Повышение квалификации аудиторов: обучение, практика, материалы, кейсы и повышение квалификации для специалистов и корпоративных команд.';

$serviceCoverHeroTitle = 'Повышение квалификации аудиторов';
$serviceCoverHeroLead = 'Программы повышения квалификации для аудиторов, ассистентов аудитора, руководителей проверок и методологов. Разбираем стандарты аудита, планирование, существенность, оценку рисков, аудиторские доказательства, рабочие документы, выводы и контроль качества.';
...
$auditOrderReasonsTitle = 'Когда нужно обучение по направлению «Повышение квалификации аудиторов»';
$auditOrderReasonsIntro = [
    'Обучение по направлению «Повышение квалификации аудиторов» нужно, если аудиторам нужно обновить знания, выстроить единый методологический подход, улучшить качество рабочих документов и снизить риск ошибок при проверках.',
...
$auditServiceTypesItems = [
    'актуальные требования и стандарты аудита',
    'планирование аудиторского задания',
    'существенность и оценка рисков',
    'аудиторские доказательства',
    'оформление рабочих документов',
    'аудит сложных участков отчетности',
    'подготовка аудиторских выводов',
    'внутренний контроль качества аудита',
];

$auditProcessTitle = 'Как проходит обучение по направлению «Повышение квалификации аудиторов»';
...
$auditProcessSteps = [
    [
        ...
        'text' => 'Вы описываете задачу, уровень подготовки участников и желаемый результат. Мы определяем, какой формат обучения по направлению «Повышение квалификации аудиторов» подойдет лучше всего.',
    ],
    [
        'number' => '02',
        'title' => 'Определение программы',
        'text' => 'Согласуем темы, продолжительность, глубину разбора, практические задания и акценты: стандарты аудита, риски, существенность, рабочие документы, доказательства, выводы и контроль качества.',
    ],
    [
        'number' => '03',
...
$auditFinalCtaTitle = 'Нужно обучение по направлению «Повышение квалификации аудиторов»?';
...
$auditFaqTitle = 'Частые вопросы по обучению «Повышение квалификации аудиторов»';
$auditFaqItems = [
    [
        'q' => 'Кому подойдет обучение «Повышение квалификации аудиторов»?',
        'a' => 'Обучение подойдет аудиторам, ассистентам аудитора, руководителям проверок, методологам и аудиторским командам, которым важно обновить знания и улучшить практику проверок.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-hsep-povyshenie-kvalifikatsii-auditorov">
