...
$pageTitle = 'Корпоративное обучение';
$pageDescription = 'Корпоративное обучение: обучение, практика, материалы, кейсы и повышение квалификации для специалистов и корпоративных команд.';

$serviceCoverHeroTitle = 'Корпоративное обучение';
$serviceCoverHeroLead = 'Корпоративное обучение для сотрудников компаний по бухгалтерии, налогам, финансам, МСФО, внутреннему аудиту, комплаенсу, управленческому учету и другим бизнес-направлениям. Программу адаптируем под отрасль, уровень команды и реальные задачи бизнеса.';
...
$auditOrderReasonsTitle = 'Когда нужно обучение по направлению «Корпоративное обучение»';
$auditOrderReasonsIntro = [
    'Обучение по направлению «Корпоративное обучение» нужно, если компании нужно выровнять уровень команды, обучить сотрудников новым требованиям, внедрить единый подход или снизить количество повторяющихся ошибок.',
...
$auditServiceTypesItems = [
    'обучение бухгалтерии и финансовой службы',
    'налоги и налоговая безопасность',
    'МСФО и международная отчетность',
    'внутренний аудит, СВК и риски',
    'комплаенс и контроль процессов',
    'управленческий учет и отчетность',
    'обучение руководителей и специалистов',
    'программы под внутренние процессы компании',
];

$auditProcessTitle = 'Как проходит обучение по направлению «Корпоративное обучение»';
...
$auditProcessSteps = [
    [
        ...
        'text' => 'Вы описываете задачу, уровень подготовки участников и желаемый результат. Мы определяем, какой формат обучения по направлению «Корпоративное обучение» подойдет лучше всего.',
    ],
    [
        'number' => '02',
        'title' => 'Определение программы',
        'text' => 'Согласуем темы, продолжительность, глубину разбора, практические задания и акценты: цели компании, уровень команды, реальные кейсы, внутренние процессы и практические навыки.',
    ],
    [
        'number' => '03',
...
$auditFinalCtaTitle = 'Нужно обучение по направлению «Корпоративное обучение»?';
...
$auditFaqTitle = 'Частые вопросы по обучению «Корпоративное обучение»';
$auditFaqItems = [
    [
        'q' => 'Кому подойдет обучение «Корпоративное обучение»?',
        'a' => 'Обучение подойдет компаниям, которым нужно обучить бухгалтерию, финансовую службу, аудиторов, HR, юристов, руководителей, комплаенс-команду или сотрудников смежных подразделений.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-hsep-korporativnoe-obuchenie">
