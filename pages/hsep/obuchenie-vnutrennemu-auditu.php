...
$pageTitle = 'Обучение внутреннему аудиту';
$pageDescription = 'Обучение внутреннему аудиту: обучение, практика, материалы, кейсы и повышение квалификации для специалистов и корпоративных команд.';

$serviceCoverHeroTitle = 'Обучение внутреннему аудиту';
$serviceCoverHeroLead = 'Обучение внутреннему аудиту для внутренних аудиторов, специалистов СВК, риск-менеджеров, финансистов и сотрудников контрольных функций. Разбираем планирование проверок, риск-ориентированный подход, тестирование контролей, рабочие документы, интервью, доказательства и подготовку отчетов.';
...
$auditOrderReasonsTitle = 'Когда нужно обучение по направлению «Обучение внутреннему аудиту»';
$auditOrderReasonsIntro = [
    'Обучение по направлению «Обучение внутреннему аудиту» нужно, если компания запускает или развивает функцию внутреннего аудита, хочет повысить качество внутренних проверок и связать аудит с рисками и контролями.',
...
$auditServiceTypesItems = [
    ...
    'оценка СВК и тестирование контролей',
    'рабочие документы аудитора',
    'интервью и сбор доказательств',
    'подготовка аудиторских отчетов',
    'контроль выполнения рекомендаций',
];

$auditProcessTitle = 'Как проходит обучение по направлению «Обучение внутреннему аудиту»';
...
$auditProcessSteps = [
    [
        ...
        'text' => 'Вы описываете задачу, уровень подготовки участников и желаемый результат. Мы определяем, какой формат обучения по направлению «Обучение внутреннему аудиту» подойдет лучше всего.',
    ],
    [
        'number' => '02',
        'title' => 'Определение программы',
        'text' => 'Согласуем темы, продолжительность, глубину разбора, практические задания и акценты: планирование аудита, риски, СВК, тестирование контролей, рабочие документы и отчеты.',
    ],
    [
        'number' => '03',
...
$auditFinalCtaTitle = 'Нужно обучение по направлению «Обучение внутреннему аудиту»?';
...
$auditFaqTitle = 'Частые вопросы по обучению «Обучение внутреннему аудиту»';
$auditFaqItems = [
    [
        'q' => 'Кому подойдет обучение «Обучение внутреннему аудиту»?',
        'a' => 'Обучение подойдет внутренним аудиторам, специалистам СВК, риск-менеджерам, финансистам, руководителям контрольных подразделений и сотрудникам, участвующим во внутренних проверках.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-hsep-obuchenie-vnutrennemu-auditu">
