...
$pageTitle = 'Сертификационные программы';
$pageDescription = 'Сертификационные программы: обучение, практика, материалы, кейсы и повышение квалификации для специалистов и корпоративных команд.';

$serviceCoverHeroTitle = 'Сертификационные программы';
$serviceCoverHeroLead = 'Сертификационные программы для специалистов и корпоративных команд. Программа может включать обучение, практические задания, проверку знаний, итоговое тестирование и подтверждение прохождения по выбранному направлению: бухгалтерия, налоги, МСФО, аудит, финансы, комплаенс или управленческий учет.';
...
$auditOrderReasonsTitle = 'Когда нужно обучение по направлению «Сертификационные программы»';
$auditOrderReasonsIntro = [
    'Обучение по направлению «Сертификационные программы» нужно, если важно не только провести обучение, но и проверить знания участников, подтвердить прохождение программы и зафиксировать уровень компетенций.',
...
$auditServiceTypesItems = [
    'сертификация по бухгалтерскому учету',
    'сертификация по налогам',
    'сертификация по МСФО',
    'сертификация по внутреннему аудиту',
    'сертификация по управленческому учету',
    'сертификация по комплаенсу и рискам',
    'практические задания и тестирование',
    'оценка знаний корпоративной команды',
];

$auditProcessTitle = 'Как проходит обучение по направлению «Сертификационные программы»';
...
$auditProcessSteps = [
    [
        ...
        'text' => 'Вы описываете задачу, уровень подготовки участников и желаемый результат. Мы определяем, какой формат обучения по направлению «Сертификационные программы» подойдет лучше всего.',
    ],
    [
        'number' => '02',
        'title' => 'Определение программы',
        'text' => 'Согласуем темы, продолжительность, глубину разбора, практические задания и акценты: компетенции, программа обучения, практические задания, тестирование, критерии оценки и подтверждение результата.',
    ],
    [
        'number' => '03',
...
$auditFinalCtaTitle = 'Нужно обучение по направлению «Сертификационные программы»?';
...
$auditFaqTitle = 'Частые вопросы по обучению «Сертификационные программы»';
$auditFaqItems = [
    [
        'q' => 'Кому подойдет обучение «Сертификационные программы»?',
        'a' => 'Обучение подойдет специалистам, корпоративным командам и компаниям, которым важно обучить сотрудников и подтвердить уровень знаний по выбранному направлению.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-hsep-sertifikatsionnye-programmy">
