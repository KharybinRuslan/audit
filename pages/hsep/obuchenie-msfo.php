...
$pageTitle = 'Обучение МСФО';
$pageDescription = 'Обучение МСФО: обучение, практика, материалы, кейсы и повышение квалификации для специалистов и корпоративных команд.';

$serviceCoverHeroTitle = 'Обучение МСФО';
$serviceCoverHeroLead = 'Обучение МСФО для бухгалтеров, финансистов, аудиторов и специалистов отчетности. Разбираем принципы международных стандартов, трансформацию отчетности, консолидацию, раскрытия, учетную политику, первое применение МСФО и практические корректировки.';
...
$auditOrderReasonsTitle = 'Когда нужно обучение по направлению «Обучение МСФО»';
$auditOrderReasonsIntro = [
    'Обучение по направлению «Обучение МСФО» нужно, если компания готовит международную отчетность, переходит на МСФО, заполняет консолидационные пакеты или хочет повысить квалификацию финансовой команды.',
...
$auditServiceTypesItems = [
    'основы и принципы МСФО',
    'трансформация РСБУ в МСФО',
    'консолидация и внутригрупповые операции',
    'раскрытия и примечания к отчетности',
    'первое применение МСФО',
    'учетная политика по МСФО',
    'заполнение консолидационных пакетов',
    'практические корректировки и кейсы',
];

$auditProcessTitle = 'Как проходит обучение по направлению «Обучение МСФО»';
...
$auditProcessSteps = [
    [
        ...
        'text' => 'Вы описываете задачу, уровень подготовки участников и желаемый результат. Мы определяем, какой формат обучения по направлению «Обучение МСФО» подойдет лучше всего.',
    ],
    [
        'number' => '02',
        'title' => 'Определение программы',
        'text' => 'Согласуем темы, продолжительность, глубину разбора, практические задания и акценты: международные стандарты, трансформация, раскрытия, консолидация, учетная политика и практические корректировки.',
    ],
    [
        'number' => '03',
...
$auditFinalCtaTitle = 'Нужно обучение по направлению «Обучение МСФО»?';
...
$auditFaqTitle = 'Частые вопросы по обучению «Обучение МСФО»';
$auditFaqItems = [
    [
        'q' => 'Кому подойдет обучение «Обучение МСФО»?',
        'a' => 'Обучение подойдет бухгалтерам, финансистам, аудиторам, специалистам по отчетности и командам, которые готовят, проверяют или используют отчетность по МСФО.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-hsep-obuchenie-msfo">
