...
$pageTitle = 'Онлайн-курсы';
$pageDescription = 'Онлайн-курсы: обучение, практика, материалы, кейсы и повышение квалификации для специалистов и корпоративных команд.';

$serviceCoverHeroTitle = 'Онлайн-курсы';
$serviceCoverHeroLead = 'Онлайн-курсы для специалистов и корпоративных команд по бухгалтерии, налогам, финансам, МСФО, аудиту, комплаенсу и управленческому учету. Формат подходит для дистанционного обучения, модульных программ, вебинаров, практикумов и обучения сотрудников из разных городов.';
...
$auditOrderReasonsTitle = 'Когда нужно обучение по направлению «Онлайн-курсы»';
$auditOrderReasonsIntro = [
    'Обучение по направлению «Онлайн-курсы» нужно, если участники находятся в разных городах, нужно гибко встроить обучение в рабочий график или провести курс без очных встреч.',
...
$auditServiceTypesItems = [
    'дистанционные курсы для специалистов',
    'онлайн-обучение корпоративных команд',
    'вебинары и модульные программы',
    'практические задания и тесты',
    'записи занятий и материалы',
    'курсы по бухгалтерии и налогам',
    'курсы по МСФО, аудиту и финансам',
    'гибкий график обучения',
];

$auditProcessTitle = 'Как проходит обучение по направлению «Онлайн-курсы»';
...
$auditProcessSteps = [
    [
        ...
        'text' => 'Вы описываете задачу, уровень подготовки участников и желаемый результат. Мы определяем, какой формат обучения по направлению «Онлайн-курсы» подойдет лучше всего.',
    ],
    [
        'number' => '02',
        'title' => 'Определение программы',
        'text' => 'Согласуем темы, продолжительность, глубину разбора, практические задания и акценты: онлайн-формат, темы курса, практические задания, записи, материалы и работа с вопросами участников.',
    ],
    [
        'number' => '03',
...
$auditFinalCtaTitle = 'Нужно обучение по направлению «Онлайн-курсы»?';
...
$auditFaqTitle = 'Частые вопросы по обучению «Онлайн-курсы»';
$auditFaqItems = [
    [
        'q' => 'Кому подойдет обучение «Онлайн-курсы»?',
        'a' => 'Обучение подойдет специалистам, руководителям и корпоративным командам, которым удобно проходить обучение дистанционно без привязки к офису или городу.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-hsep-onlayn-kursy">
