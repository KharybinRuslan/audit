...
$pageTitle = 'Оценка активов (имущество, НМА)';

$pageDescription = 'Оценка активов ООО "Аудит Топ Эксперт": оценка имущества, оборудования, недвижимости, нематериальных активов и прав для бизнеса, суда и сделок.';

$serviceCoverHeroTitle = 'Оценка активов: имущество, оборудование и НМА';

$serviceCoverHeroLead = 'Проведем оценку активов компании: имущества, оборудования, недвижимости, нематериальных активов, прав, долей и отдельных объектов. Поможем определить рыночную или расчетную стоимость для сделки, суда, учета, залога, инвестора или управленческого решения.';
...
$auditOrderReasonsTitle = 'Когда нужна услуга: оценка активов (имущество, нма)';

$auditOrderReasonsIntro = [
    'Оценка активов (имущество, НМА) требуется, когда нужно принять финансовое, инвестиционное, судебное или управленческое решение на основе проверенных данных, расчетов и понятных выводов.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];

$auditOrderReasonsItems = [
    'нужно определить стоимость имущества, оборудования или НМА',
    'планируется продажа, покупка, вклад в уставный капитал или залог',
    'требуется расчет стоимости для суда, сделки или учета',
    'компания готовится к реструктуризации, инвентаризации или спору',
    'нужно оценить отдельный объект, портфель активов или имущественный комплекс',
    'есть необходимость подтвердить стоимость для инвестора, банка или собственников',
];

$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает результат оценки активов';

$auditCheckResultsParagraphs = [
    'Результат оценки активов показывает, какие финансовые показатели, предпосылки, активы, обязательства, риски или ограничения влияют на решение и какие выводы можно сделать на основе документов.',
...
$auditQuestionsTitle = 'Какие задачи решает оценка активов (имущество, нма)';

$auditQuestionsIntro = 'Перечень вопросов зависит от цели работы, но чаще всего услуга помогает ответить на следующие вопросы:';

$auditQuestionsItems = [
    'какова стоимость конкретного актива',
    'какие характеристики влияют на цену имущества или НМА',
    'какие документы подтверждают право и состояние объекта',
    'можно ли использовать актив в качестве залога или вклада',
    'есть ли риски завышения или занижения стоимости',
    'какой подход к оценке подходит для объекта',
    'как представить расчет для суда, сделки или учета',
    'какие данные нужно дополнить для точной оценки',
];
...
$auditServiceTypesIntro = 'Оценка активов (имущество, НМА) может быть выполнена в кратком, стандартном или комплексном формате. Выбор зависит от цели, объема данных, срочности и требований к итоговому документу.';

$auditServiceTypesLead = 'К основным форматам относятся:';

$auditServiceTypesItems = [
    'оценка имущества и оборудования',
    'оценка недвижимости и имущественных комплексов',
    'оценка нематериальных активов и прав',
    'оценка активов для сделки или залога',
    'оценка активов для суда',
    'оценка активов для учета и управленческих решений',
    'экспресс-оценка отдельных объектов',
    'комплексная оценка портфеля активов',
];

$auditProcessTitle = 'Как проходит оценка активов (имущество, нма)';
...
$auditPricingIntro = 'Стоимость оценки активов рассчитывается индивидуально и зависит от объема данных, сложности расчетов, срочности, периода анализа и требуемого формата результата.';
...
$auditDocumentsNeededItems = [
    'документы, подтверждающие право на актив',
    'описание объекта и его технические характеристики',
    'инвентарные карточки и учетные данные',
    'договоры покупки, аренды, передачи или использования',
    'фотографии, спецификации, паспорта или акты осмотра',
    'данные о состоянии, износе и ограничениях',
    'сведения о доходах от использования актива, если применимо',
    'цель оценки и требования к результату',
];
...
$auditResultsSummaryTitle = 'Что вы получите по итогам оценки активов';
...
$auditResultsSummaryItems = [
    'расчет стоимости актива или группы активов',
    'описание объекта и исходных данных',
    'обоснование выбранного подхода к оценке',
    'анализ факторов, влияющих на стоимость',
    'выводы для сделки, суда, учета или залога',
    'перечень недостающих данных и рисков',
    'понятный итоговый материал для руководства или внешних пользователей',
];
...
$auditFinalCtaTitle = 'Нужна услуга «Оценка активов (имущество, НМА)»? Начнем с оценки задачи';
...
$auditFaqTitle = 'Частые вопросы: оценка активов (имущество, нма)';

$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Оценка активов (имущество, НМА)»?',
...
<body class="has-site-header has-breadcrumbs page-finans-otsenka-aktivov">
