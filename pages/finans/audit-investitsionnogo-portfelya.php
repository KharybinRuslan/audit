...
$pageTitle = 'Аудит инвестиционного портфеля';

$pageDescription = 'Аудит инвестиционного портфеля ООО "Аудит Топ Эксперт": анализ структуры, рисков, доходности, концентрации, ликвидности и соответствия целям.';

$serviceCoverHeroTitle = 'Аудит инвестиционного портфеля';

$serviceCoverHeroLead = 'Проведем аудит инвестиционного портфеля: оценим структуру активов, доходность, риски, ликвидность, концентрацию, диверсификацию и соответствие заявленным целям. Подготовим независимый обзор и рекомендации по дальнейшему контролю.';
...
$auditOrderReasonsTitle = 'Когда нужна услуга: аудит инвестиционного портфеля';

$auditOrderReasonsIntro = [
    'Аудит инвестиционного портфеля требуется, когда нужно принять финансовое, инвестиционное, судебное или управленческое решение на основе проверенных данных, расчетов и понятных выводов.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];

$auditOrderReasonsItems = [
    'нужно понять структуру и риски текущего портфеля',
    'портфель собирался постепенно и требует независимого обзора',
    'есть сомнения в диверсификации, ликвидности или концентрации',
    'важно сравнить фактическую структуру с целями инвестора',
    'требуется оценить доходность и риск по классам активов',
    'нужен отчет для собственников, семьи, управляющего или внутреннего контроля',
];

$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает результат аудита инвестиционного портфеля';

$auditCheckResultsParagraphs = [
    'Результат аудита инвестиционного портфеля показывает, какие финансовые показатели, предпосылки, активы, обязательства, риски или ограничения влияют на решение и какие выводы можно сделать на основе документов.',
...
$auditQuestionsTitle = 'Какие задачи решает аудит инвестиционного портфеля';

$auditQuestionsIntro = 'Перечень вопросов зависит от цели работы, но чаще всего услуга помогает ответить на следующие вопросы:';

$auditQuestionsItems = [
    'из каких активов состоит портфель',
    'насколько портфель диверсифицирован',
    'есть ли избыточная концентрация в отдельных инструментах или секторах',
    'какова фактическая доходность и просадка',
    'достаточно ли ликвидности для целей инвестора',
    'какие риски неочевидны по текущей структуре',
    'соответствует ли портфель горизонту и допустимому риску',
    'какие изменения стоит рассмотреть для контроля рисков',
];
...
$auditServiceTypesIntro = 'Аудит инвестиционного портфеля может быть выполнена в кратком, стандартном или комплексном формате. Выбор зависит от цели, объема данных, срочности и требований к итоговому документу.';
...
$auditServiceTypesItems = [
    ...
    'анализ диверсификации и концентрации',
    'оценка ликвидности активов',
    'сравнение портфеля с целями и горизонтом',
    'аудит комиссий, издержек и ограничений',
    'подготовка отчета для собственников',
    'рекомендации по контролю и ребалансировке',
];

$auditProcessTitle = 'Как проходит аудит инвестиционного портфеля';
...
$auditPricingIntro = 'Стоимость аудита инвестиционного портфеля рассчитывается индивидуально и зависит от объема данных, сложности расчетов, срочности, периода анализа и требуемого формата результата.';
...
$auditDocumentsNeededItems = [
    'перечень активов и их доли в портфеле',
    'история операций и пополнений, если есть',
    'данные о текущей стоимости активов',
    'информация о целях, горизонте и допустимом риске',
    'условия счетов, комиссий и ограничений',
    'отчеты брокера, банка или управляющего',
    'описание валютной структуры портфеля',
    'пожелания по ликвидности и доходности',
];
...
$auditResultsSummaryTitle = 'Что вы получите по итогам аудита инвестиционного портфеля';
...
$auditResultsSummaryItems = [
    'обзор структуры инвестиционного портфеля',
    'анализ доходности, риска и ликвидности',
    'оценку концентрации и диверсификации',
    'выявление слабых мест и скрытых рисков',
    'сравнение портфеля с целями инвестора',
    'рекомендации по контролю и возможной ребалансировке',
    'понятный отчет для дальнейших решений',
];
...
$auditFinalCtaTitle = 'Нужна услуга «Аудит инвестиционного портфеля»? Начнем с оценки задачи';
...
$auditFaqTitle = 'Частые вопросы: аудит инвестиционного портфеля';

$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Аудит инвестиционного портфеля»?',
...
<body class="has-site-header has-breadcrumbs page-finans-audit-investitsionnogo-portfelya">
