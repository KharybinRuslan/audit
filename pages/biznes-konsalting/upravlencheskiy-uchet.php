...
$pageTitle = 'Управленческий учет';
$pageDescription = 'ДДС, ОПиУ, баланс, аналитика и контроль: видеть движение денежных средств, понимать прибыльность направлений, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Управленческий учет';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Управленческий учет»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 7 рабочих дней',
    'ДДС, ОПиУ, баланс, аналитика и контроль',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Управленческий учет»';
$auditOrderReasonsIntro = [
    'Услуга «Управленческий учет» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'руководство не понимает, где бизнес зарабатывает и теряет деньги',
    'нет регулярных отчетов ДДС, ОПиУ и баланса',
    'данные собираются вручную и не совпадают',
    'нужно контролировать проекты и подразделения',
    'компания планирует рост или кредитование',
    'собственникам нужна финансовая прозрачность',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Управленческий учет»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Управленческий учет» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Управленческий учет»';
...
$auditQuestionsItems = [
    ...
    'понимать прибыльность направлений',
    'контролировать расходы',
    'настроить план-факт анализ',
    'оценивать маржинальность',
    'сформировать регулярные отчеты',
    'связать финансы с операционными показателями',
    'подготовить данные для решений',
];
...
$auditDocumentsNeededItems = [
    ...
    'данные по продажам и платежам',
    'структура компании',
    'перечень проектов',
    'планы и бюджеты',
    'описание процесса отчетности',
...
$auditResultsSummaryItems = [
    'структуру управленческой отчетности',
    'формы ДДС, ОПиУ и баланса',
    'аналитики и классификаторы',
    'методологию учета',
    'регламент подготовки отчетов',
    'рекомендации по план-факт контролю',
    'систему данных для руководства',
];
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Управленческий учет»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Управленческий учет»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Управленческий учет»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Управленческий учет»?',
    ...
    [
        ...
        'a' => 'Обычно нужны текущие управленческие отчеты, бухгалтерские данные, данные по продажам и платежам, структура компании, перечень проектов. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите структуру управленческой отчетности, формы ДДС, ОПиУ и баланса, аналитики и классификаторы, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-upravlencheskiy-uchet">
