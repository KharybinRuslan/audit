...
$pageTitle = 'Автоматизация управленческого учета';
$pageDescription = 'Отчеты, данные, аналитика, дашборды и регламенты: сократить ручной сбор отчетов, настроить единые правила учета, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Автоматизация управленческого учета';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Автоматизация управленческого учета»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 10 рабочих дней',
    'Отчеты, данные, аналитика, дашборды и регламенты',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Автоматизация управленческого учета»';
$auditOrderReasonsIntro = [
    'Услуга «Автоматизация управленческого учета» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
...
$auditOrderReasonsItems = [
    ...
    'руководству нужны отчеты без задержек',
    'не хватает аналитики по проектам',
    'нужно настроить дашборды',
    'компания хочет снизить ручную обработку данных',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Автоматизация управленческого учета»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Автоматизация управленческого учета» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Автоматизация управленческого учета»';
$auditQuestionsIntro = 'Перечень задач зависит от цели обращения, но чаще всего услуга помогает решить следующие вопросы:';
$auditQuestionsItems = [
    'сократить ручной сбор отчетов',
    'настроить единые правила учета',
    'связать данные из разных источников',
    'автоматизировать ДДС и ОПиУ',
    'настроить план-факт контроль',
...
$auditServiceTypesItems = [
    'диагностика отчетов и данных',
    'описание требований',
    'разработка методологии',
    'настройка форм отчетности',
    'аналитики и классификаторы',
    'настройка источников данных',
    'создание дашбордов',
    'регламент контроля отчетности',
];
...
$auditDocumentsNeededItems = [
    'текущие управленческие отчеты',
    'Excel-файлы и шаблоны',
    'описание учетных систем',
    'выгрузки по продажам и платежам',
    'структура проектов',
    'планы и бюджеты',
...
$auditResultsSummaryItems = [
    'план автоматизации',
    'описание требований и методологии',
    'настроенные формы отчетности',
    'аналитики и правила учета',
    'дашборды или контрольные отчеты',
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Автоматизация управленческого учета»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Автоматизация управленческого учета»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Автоматизация управленческого учета»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Автоматизация управленческого учета»?',
    ...
    [
        ...
        'a' => 'Обычно нужны текущие управленческие отчеты, Excel-файлы и шаблоны, описание учетных систем, выгрузки по продажам и платежам, структура проектов. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите план автоматизации, описание требований и методологии, настроенные формы отчетности, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-avtomatizatsiya-upravlencheskogo-ucheta">
