...
$pageTitle = 'Услуги по регистрации ООО';
$pageDescription = 'Документы, ОКВЭД, налоговый режим и сопровождение: выбрать форму ведения бизнеса, определить налоговый режим, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Услуги по регистрации ООО';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Услуги по регистрации ООО»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 3 рабочих дней',
    'Документы, ОКВЭД, налоговый режим и сопровождение',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Услуги по регистрации ООО»';
$auditOrderReasonsIntro = [
    'Услуга «Услуги по регистрации ООО» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'планируется запуск нового бизнеса',
    'нужно выбрать подходящую форму работы',
    'у проекта несколько участников или партнеров',
    'важно выбрать налоговый режим',
    'нужно избежать ошибок в регистрационных документах',
    'требуется сопровождение после регистрации',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Услуги по регистрации ООО»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Услуги по регистрации ООО» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Услуги по регистрации ООО»';
...
$auditQuestionsItems = [
    ...
    'учесть состав участников и руководителя',
...
$auditDocumentsNeededItems = [
    ...
    'сведения о будущем названии',
    'информация об адресе',
    'данные о руководителе',
    'виды деятельности',
    'решение по налоговому режиму',
    'размер и распределение долей',
    'контактные данные',
];
...
$auditResultsSummaryItems = [
    ...
    'устав, решение или протокол',
    'подобранные коды ОКВЭД',
    'рекомендации по налоговому режиму',
    'сопровождение подачи документов',
    'результат регистрации',
    'перечень дальнейших действий',
];
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Услуги по регистрации ООО»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Услуги по регистрации ООО»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Услуги по регистрации ООО»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Услуги по регистрации ООО»?',
    ...
    [
        ...
        'a' => 'Обычно нужны паспортные данные участников, сведения о будущем названии, информация об адресе, данные о руководителе, виды деятельности. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите подготовленный пакет документов, устав, решение или протокол, подобранные коды ОКВЭД, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-uslugi-po-registratsii-ooo">
