...
$pageTitle = 'Подготовка ЛНА';
$pageDescription = 'Положения, правила, регламенты и внутренние политики: разработать обязательные кадровые документы, оформить правила внутреннего трудового распорядка, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Подготовка ЛНА';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Подготовка ЛНА»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 3 рабочих дней',
    'Положения, правила, регламенты и внутренние политики',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Подготовка ЛНА»';
$auditOrderReasonsIntro = [
    'Услуга «Подготовка ЛНА» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'в компании нет необходимых внутренних положений',
    'документы устарели',
    'нужно подготовиться к проверке ГИТ',
    'изменились кадровые процессы или система оплаты',
    'необходимо снизить риск трудовых споров',
    'компания хочет формализовать правила для сотрудников',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Подготовка ЛНА»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Подготовка ЛНА» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Подготовка ЛНА»';
$auditQuestionsIntro = 'Перечень задач зависит от цели обращения, но чаще всего услуга помогает решить следующие вопросы:';
$auditQuestionsItems = [
    'разработать обязательные кадровые документы',
    'оформить правила внутреннего трудового распорядка',
    'подготовить положения об оплате труда',
    'описать режим работы',
    'закрепить внутренние политики',
    'снизить риск трудовых споров',
    'подготовиться к проверке ГИТ',
    'привести документы в соответствие с процессами',
];
...
$auditServiceTypesItems = [
    ...
    'регламенты кадрового документооборота',
...
$auditResultsSummaryItems = [
    'готовые локальные нормативные акты',
    'перечень документов для внедрения',
    'рекомендации по кадровым рискам',
    'обновленные положения и правила',
    'регламенты и инструкции',
    'рекомендации по ознакомлению сотрудников',
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Подготовка ЛНА»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Подготовка ЛНА»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Подготовка ЛНА»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Подготовка ЛНА»?',
    ...
    [
        ...
        'a' => 'Обычно нужны действующие ЛНА, трудовые договоры, штатное расписание, должностные инструкции, описание режима работы. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите готовые локальные нормативные акты, перечень документов для внедрения, рекомендации по кадровым рискам, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-podgotovka-lna">
