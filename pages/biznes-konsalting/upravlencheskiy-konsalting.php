...
$pageTitle = 'Управленческий консалтинг';
$pageDescription = 'Практические рекомендации и документы: проанализировать текущую ситуацию и документы, выявить риски, ошибки и слабые места, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Управленческий консалтинг';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Управленческий консалтинг»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 3 рабочих дней',
    'Практические рекомендации и документы',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Управленческий консалтинг»';
$auditOrderReasonsIntro = [
    'Услуга «Управленческий консалтинг» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'нужно получить независимую оценку ситуации',
    'требуется подготовить документы или рекомендации',
    'есть риски, которые важно выявить заранее',
    'компания готовится к сделке, проверке, запуску или изменению процессов',
    'руководству нужен понятный план дальнейших действий',
    'необходимо снизить вероятность ошибок, претензий или финансовых потерь',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Управленческий консалтинг»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Управленческий консалтинг» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Управленческий консалтинг»';
$auditQuestionsIntro = 'Перечень задач зависит от цели обращения, но чаще всего услуга помогает решить следующие вопросы:';
$auditQuestionsItems = [
    'проанализировать текущую ситуацию и документы',
    'выявить риски, ошибки и слабые места',
    'подготовить практические рекомендации',
    'определить порядок дальнейших действий',
    'сформировать документы, расчеты или итоговые материалы',
    'помочь руководству принять обоснованное решение',
    'снизить нагрузку на внутреннюю команду',
    'сопроводить внедрение решений при необходимости',
];
...
$auditDocumentsNeededItems = [
    'описание ситуации или задачи',
    'действующие документы компании',
    'договоры, отчеты и регламенты',
    'учетные или управленческие данные',
    'пояснения ответственных сотрудников',
    'переписка и дополнительные материалы',
    'требования банка, инвестора или контролирующего органа',
...
$auditResultsSummaryItems = [
    'практические выводы по ситуации',
    'перечень выявленных рисков',
    'рекомендации по дальнейшим действиям',
    'подготовленные документы или материалы',
    'план работ и приоритеты',
    'позицию для руководства или собственников',
    'сопровождение внедрения при необходимости',
];
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Управленческий консалтинг»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Управленческий консалтинг»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Управленческий консалтинг»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Управленческий консалтинг»?',
    ...
    [
        ...
        'a' => 'Обычно нужны описание ситуации или задачи, действующие документы компании, договоры, отчеты и регламенты, учетные или управленческие данные, пояснения ответственных сотрудников. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите практические выводы по ситуации, перечень выявленных рисков, рекомендации по дальнейшим действиям, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-upravlencheskiy-konsalting">
