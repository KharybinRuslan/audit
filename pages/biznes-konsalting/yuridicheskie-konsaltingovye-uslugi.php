...
$pageTitle = 'Юридические консалтинговые услуги';
$pageDescription = 'Договоры, риски, документы и сопровождение: проверить договоры и документы, оценить риски сделки, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Юридические консалтинговые услуги';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Юридические консалтинговые услуги»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 1 рабочего дня',
    'Договоры, риски, документы и сопровождение',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Юридические консалтинговые услуги»';
$auditOrderReasonsIntro = [
    'Услуга «Юридические консалтинговые услуги» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'нужно проверить или подготовить договор',
    'возник спор с контрагентом или партнером',
    'планируется сделка или изменение структуры бизнеса',
    'требуется оценить правовые риски',
    'нужно подготовить внутренние документы',
    'руководству нужна юридическая позиция',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Юридические консалтинговые услуги»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Юридические консалтинговые услуги» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Юридические консалтинговые услуги»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Юридические консалтинговые услуги»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Юридические консалтинговые услуги»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Юридические консалтинговые услуги»?',
    ...
    [
        ...
        'a' => 'Обычно нужны описание ситуации, договоры и приложения, переписка с контрагентами, претензии или требования, корпоративные документы. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите юридическую консультацию, анализ правовых рисков, рекомендации по действиям, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-yuridicheskie-konsaltingovye-uslugi">
