...
$serviceCoverHeroTitle = 'Регистрация бизнеса';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Регистрация бизнеса»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Регистрация бизнеса»';
$auditOrderReasonsIntro = [
    'Услуга «Регистрация бизнеса» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
...
$auditCheckResultsTitle = 'Что показывает работа по услуге «Регистрация бизнеса»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Регистрация бизнеса» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Регистрация бизнеса»';
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Регистрация бизнеса»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Регистрация бизнеса»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Регистрация бизнеса»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Регистрация бизнеса»?',
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-registratsiya-biznesa">
