...
$pageTitle = 'Стратегический консалтинг';
$pageDescription = 'Стратегия, цели, риски и план развития: оценить текущую бизнес-модель, найти точки роста и ограничения, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Стратегический консалтинг';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Стратегический консалтинг»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 7 рабочих дней',
    'Стратегия, цели, риски и план развития',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Стратегический консалтинг»';
$auditOrderReasonsIntro = [
    'Услуга «Стратегический консалтинг» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'компания планирует масштабирование или выход на новые рынки',
    'текущая бизнес-модель перестала давать ожидаемый результат',
    'собственникам нужна независимая оценка стратегии',
    'нужно определить приоритеты развития',
    'есть несколько сценариев и нужно выбрать реалистичный',
    'важно связать цели, ресурсы и финансовые показатели',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Стратегический консалтинг»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Стратегический консалтинг» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Стратегический консалтинг»';
$auditQuestionsIntro = 'Перечень задач зависит от цели обращения, но чаще всего услуга помогает решить следующие вопросы:';
$auditQuestionsItems = [
    'оценить текущую бизнес-модель',
    'найти точки роста и ограничения',
    'сформировать сценарии развития',
    'оценить риски выбранной стратегии',
    'определить приоритеты и ресурсы',
    'подготовить план действий',
    'связать стратегию с финансами и процессами',
    'подготовить материалы для собственников',
];
...
$auditDocumentsNeededItems = [
    ...
    'данные о продуктах, клиентах и рынке',
    'организационная структура',
    'планы развития',
    'данные о проектах и ограничениях',
...
$auditResultsSummaryItems = [
    ...
    'оценку точек роста и ограничений',
    'сценарии развития',
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Стратегический консалтинг»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Стратегический консалтинг»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Стратегический консалтинг»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Стратегический консалтинг»?',
    ...
    [
        ...
        'a' => 'Обычно нужны описание бизнеса, финансовые и управленческие показатели, данные о продуктах, клиентах и рынке, организационная структура, планы развития. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите стратегические выводы, оценку точек роста и ограничений, сценарии развития, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-strategicheskiy-konsalting">
