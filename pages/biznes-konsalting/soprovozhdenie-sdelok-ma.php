...
$pageTitle = 'Сопровождение сделок (M&A)';
$pageDescription = 'Due diligence, риски, структура и документы сделки: проверить компанию или актив, подготовить бизнес к продаже, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Сопровождение сделок (M&A)';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Сопровождение сделок (M&A)»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 7 рабочих дней',
    'Due diligence, риски, структура и документы сделки',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Сопровождение сделок (M&A)»';
$auditOrderReasonsIntro = [
    'Услуга «Сопровождение сделок (M&A)» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'планируется покупка или продажа бизнеса',
    'нужно проверить актив перед сделкой',
    'требуется оценить финансовые, налоговые и юридические риски',
    'необходимо подготовить структуру сделки',
    'стороны обсуждают цену и гарантии',
    'нужно сопровождение до закрытия сделки',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Сопровождение сделок (M&A)»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Сопровождение сделок (M&A)» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Сопровождение сделок (M&A)»';
$auditQuestionsIntro = 'Перечень задач зависит от цели обращения, но чаще всего услуга помогает решить следующие вопросы:';
$auditQuestionsItems = [
    'проверить компанию или актив',
    'подготовить бизнес к продаже',
    'оценить риски сделки',
    'определить условия и структуру',
    'подготовить материалы для переговоров',
    'сформировать перечень гарантий',
    'снизить риск споров после сделки',
    'сопроводить закрытие',
];
...
$auditResultsSummaryItems = [
    'отчет по рискам сделки',
    'финансовые, налоговые и юридические выводы',
    'перечень критичных вопросов',
    'рекомендации по структуре сделки',
    'предложения по условиям и гарантиям',
    'материалы для переговоров',
    'сопровождение дальнейших действий',
];
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Сопровождение сделок (M&A)»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Сопровождение сделок (M&A)»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Сопровождение сделок (M&A)»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Сопровождение сделок (M&A)»?',
    ...
    [
        ...
        'a' => 'Обычно нужны корпоративные документы, финансовая и бухгалтерская отчетность, налоговые декларации, договоры с контрагентами, данные по активам и обязательствам. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите отчет по рискам сделки, финансовые, налоговые и юридические выводы, перечень критичных вопросов, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-soprovozhdenie-sdelok-ma">
