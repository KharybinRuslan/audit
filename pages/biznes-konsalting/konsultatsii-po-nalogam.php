...
$pageDescription = 'Налоги, риски, ФНС, сделки и рекомендации: оценить налоговые последствия сделки, подготовиться к ответу ФНС, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Консультации по налогам';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Консультации по налогам»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 1 рабочего дня',
    'Налоги, риски, ФНС, сделки и рекомендации',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Консультации по налогам»';
$auditOrderReasonsIntro = [
    'Услуга «Консультации по налогам» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'получено требование от налогового органа',
    'нужно оценить налоговые последствия сделки',
    'есть риск доначислений и штрафов',
    'требуется выбрать или изменить налоговый режим',
    'компания хочет законно оптимизировать налоги',
    'руководству нужна независимая налоговая позиция',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Консультации по налогам»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Консультации по налогам» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Консультации по налогам»';
$auditQuestionsIntro = 'Перечень задач зависит от цели обращения, но чаще всего услуга помогает решить следующие вопросы:';
$auditQuestionsItems = [
    'оценить налоговые последствия сделки',
    'подготовиться к ответу ФНС',
    'проверить налоговые риски',
    'выбрать налоговый режим',
    'разобрать спорный вопрос',
    'оценить возможность законной оптимизации',
    'исправить ошибки в налоговом учете',
    'подготовить письменную позицию',
];
...
$auditServiceTypesItems = [
    'устная налоговая консультация',
    'письменная налоговая консультация',
    'анализ требования ФНС',
    'консультация по сделке',
    'оценка налоговых рисков',
    'консультация по оптимизации',
    'выбор налогового режима',
    'сопровождение взаимодействия с ФНС',
];
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Консультации по налогам»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Консультации по налогам»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Консультации по налогам»';
$auditFaqItems = [
    [
    ...
    [
        ...
        'a' => 'Обычно нужны описание вопроса, договоры и приложения, первичные документы, налоговые декларации, требования или письма ФНС. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите налоговую консультацию, оценку налоговых последствий, перечень налоговых рисков, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-konsultatsii-po-nalogam">
