...
$pageTitle = 'Бухгалтерские консультации';
$pageDescription = 'Учет, документы, отчетность и рекомендации: проверить отражение операций, разобраться с первичными документами, рекомендации и сопровождение.';

$serviceCoverHeroTitle = 'Бухгалтерские консультации';
$serviceCoverHeroLead = 'Поможем решить задачу по направлению «Бухгалтерские консультации»: проведем анализ ситуации, изучим документы, выявим риски, подготовим рекомендации и практический план действий. Учитываем цели бизнеса, сроки, документы и возможные последствия для компании.';
$serviceCoverHeroBullets = [
    'Стоимость — рассчитывается индивидуально',
    'Срок — от 1 рабочего дня',
    'Учет, документы, отчетность и рекомендации',
...
$auditOrderReasonsTitle = 'В каких случаях заказывают услугу «Бухгалтерские консультации»';
$auditOrderReasonsIntro = [
    'Услуга «Бухгалтерские консультации» нужна, когда компании важно получить независимую оценку ситуации, подготовить документы, снизить риски или выстроить понятный порядок дальнейших действий.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];
$auditOrderReasonsItems = [
    'нужно правильно отразить операцию в учете',
    'есть ошибки в отчетности или первичных документах',
    'бухгалтеру нужна независимая позиция',
    'руководитель хочет проверить корректность учета',
    'компания меняет процессы или договоры',
    'требуется письменная рекомендация',
];
$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает работа по услуге «Бухгалтерские консультации»';
$auditCheckResultsParagraphs = [
    'Работа по направлению «Бухгалтерские консультации» помогает увидеть текущее состояние вопроса, выявить риски, слабые места, спорные участки и варианты решения.',
...
$auditQuestionsTitle = 'Какие задачи решает услуга «Бухгалтерские консультации»';
$auditQuestionsIntro = 'Перечень задач зависит от цели обращения, но чаще всего услуга помогает решить следующие вопросы:';
$auditQuestionsItems = [
    'проверить отражение операций',
    'разобраться с первичными документами',
    'исправить ошибки в учете',
    'оценить риски в отчетности',
    'подготовить рекомендации для бухгалтерии',
    'разобрать спорную операцию',
    'оценить учетные последствия договора',
...
$auditServiceTypesItems = [
    ...
    'разбор сложной операции',
    'консультация по исправлению ошибок',
    'консультация по отчетности',
...
$auditResultsSummaryItems = [
    'устную или письменную консультацию',
    'анализ документов',
    'рекомендации по отражению операций',
    'перечень ошибок и рисков',
    'порядок исправления',
    'пояснения для бухгалтера',
    'план действий',
];
...
$auditMandatoryPrepTitle = 'Нужно подготовиться к услуге «Бухгалтерские консультации»?';
...
$auditFinalCtaTitle = 'Нужна услуга «Бухгалтерские консультации»? Начнем с оценки вашей ситуации';
...
$auditFaqTitle = 'Частые вопросы по услуге «Бухгалтерские консультации»';
$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Бухгалтерские консультации»?',
    ...
    [
        ...
        'a' => 'Обычно нужны описание вопроса, договоры и приложения, акты, счета, накладные, УПД, платежные документы, учетные регистры. Полный перечень зависит от задачи и уточняется после первичного анализа.',
    ],
    [
    ...
    [
        ...
        'a' => 'По итогам вы получите устную или письменную консультацию, анализ документов, рекомендации по отражению операций, понятные выводы, рекомендации и перечень дальнейших действий.',
    ],
    [
...
<body class="has-site-header has-breadcrumbs page-biznes-konsalting-buhgalterskie-konsultatsii">
