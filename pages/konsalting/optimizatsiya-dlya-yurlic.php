...
$pageTitle = 'Оптимизация для юрлиц';

$pageDescription = 'Оптимизация налогов для юридических лиц ООО "Аудит Топ Эксперт": анализ модели бизнеса, договоров, налоговой нагрузки и рисков для компаний.';

$serviceCoverHeroTitle = 'Оптимизация налогов для юридических лиц';

$serviceCoverHeroLead = 'Поможем юридическому лицу оценить налоговую нагрузку, проверить договорную и учетную модель, выявить законные способы повышения эффективности и снизить риск претензий со стороны налоговых органов.';
...
$auditOrderReasonsTitle = 'Когда нужна услуга: оптимизация для юрлиц';

$auditOrderReasonsIntro = [
    'Оптимизация для юрлиц требуется, когда компании важно заранее оценить налоговые последствия, подготовить документы, снизить риски и принять безопасное управленческое решение.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];

$auditOrderReasonsItems = [
    'компания хочет снизить налоговую нагрузку без спорных схем',
    'нужно проверить действующую структуру договоров, потоков и учета',
    'планируется изменение системы работы, направлений деятельности или группы компаний',
    'есть риски по НДС, прибыли, УСН, зарплатным налогам или операциям с взаимозависимыми лицами',
    'руководству нужна независимая оценка налоговой эффективности',
    'важно подготовить законную и документально подтвержденную модель работы',
];

$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает результат оптимизации налогов для юрлиц';
...
$auditQuestionsTitle = 'Какие задачи решает оптимизация для юрлиц';
...
$auditQuestionsItems = [
    'какие налоги формируют основную нагрузку',
    'есть ли законные резервы для снижения налоговых платежей',
    'какие договоры, документы или процессы нужно изменить',
    'какие решения могут вызвать претензии налогового органа',
    'как сохранить деловую цель и экономический смысл операций',
    'какие риски связаны с текущей структурой работы',
    'какой вариант будет безопаснее для компании',
    'что нужно внедрить в учете и документообороте',
];
...
$auditServiceTypesIntro = 'Оптимизация для юрлиц может быть выполнена в виде разовой консультации, письменной позиции, анализа документов или комплексного сопровождения. Формат зависит от срочности, рисков и количества материалов.';

$auditServiceTypesLead = 'Возможные форматы работы:';

$auditServiceTypesItems = [
    'анализ налоговой нагрузки',
    'проверка договорной модели',
    'оценка налоговых последствий операций',
    'анализ НДС, прибыли, УСН, НДФЛ и страховых взносов',
    'проверка рисков дробления бизнеса',
    'подготовка рекомендаций по документообороту',
    'сравнение вариантов налоговой модели',
    'сопровождение внедрения безопасных решений',
];

$auditProcessTitle = 'Как проходит оптимизация для юрлиц';
...
$auditProcessSteps = [
    [
        'number' => '01',
        'title' => 'Анализ текущей модели',
        'text' => 'Изучаем, как устроены продажи, закупки, договоры, расчеты, учет и налоговая нагрузка компании.',
    ],
    [
        'number' => '02',
        'title' => 'Выявление резервов',
        'text' => 'Определяем, где есть законные возможности для улучшения налоговой эффективности и какие участки требуют осторожности.',
    ],
    [
        'number' => '03',
        'title' => 'Оценка рисков',
        'text' => 'Проверяем, не создают ли возможные решения риск дробления бизнеса, необоснованной выгоды или претензий по документам.',
    ],
    [
        'number' => '04',
        'title' => 'Сравнение вариантов',
        'text' => 'Показываем несколько подходов, их плюсы, ограничения, налоговый эффект и уровень безопасности.',
    ],
    [
        'number' => '05',
        'title' => 'Подготовка рекомендаций',
        'text' => 'Формируем практические шаги по договорам, учету, документообороту, внутренним процессам и контрольным точкам.',
    ],
    [
        'number' => '06',
        'title' => 'Сопровождение внедрения',
        'text' => 'При необходимости помогаем внедрить выбранную модель и настроить контроль, чтобы решение работало безопасно.',
    ],
];
...
$auditPricingIntro = 'Стоимость оптимизации налогов для юрлиц рассчитывается индивидуально и зависит от объема документов, срочности, сложности налоговой ситуации и необходимости сопровождения после подготовки результата.';
...
$auditDocumentsNeededItems = [
    'краткое описание бизнеса и схемы работы',
    'налоговые декларации и бухгалтерская отчетность',
    'ОСВ, регистры учета и карточки счетов',
    'договоры с ключевыми контрагентами',
    'документы по выручке, расходам и расчетам',
    'данные по сотрудникам, выплатам и взносам',
    'информация о связанных компаниях или ИП, если есть',
    'пояснения по планируемым изменениям или сделкам',
];
...
$auditResultsSummaryTitle = 'Что вы получите по итогам оптимизации налогов для юрлиц';
...
$auditResultsSummaryItems = [
    ...
    'перечень законных возможностей для оптимизации',
    'оценку рисков по каждому варианту',
    'рекомендации по договорам и документам',
    'план внедрения изменений',
    'понимание налогового эффекта и ограничений',
    'позицию, понятную руководству, бухгалтерии и юристам',
];
...
$auditMandatoryPrepTitle = 'Нужна оптимизация для юрлица? Оценим модель бизнеса';
...
$auditFinalCtaTitle = 'Нужна оптимизация для юрлиц? Начнем с анализа модели';

$auditFinalCtaText = 'Опишите деятельность компании, текущую налоговую нагрузку и желаемый результат. Мы оценим ситуацию, предложим безопасный формат работы и подготовим рекомендации без спорных схем.';

$auditFinalCtaButtonLabel = 'Оставить заявку';

$auditFinalCtaBgUrl = '/img/audit/audit.jpg';

$auditFaqTitle = 'Частые вопросы: оптимизация для юрлиц';

$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Оптимизация для юрлиц»?',
...
<body class="has-site-header has-breadcrumbs page-konsalting-optimizatsiya-dlya-yurlic">
