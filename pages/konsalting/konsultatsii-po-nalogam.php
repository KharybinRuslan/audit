...
$pageTitle = 'Консультации по налогам';

$pageDescription = 'Консультации по налогам ООО "Аудит Топ Эксперт": ответы на вопросы по НДС, прибыли, УСН, НДФЛ, взносам, требованиям ФНС и налоговым рискам.';

$serviceCoverHeroTitle = 'Консультации по налогам для бизнеса';

$serviceCoverHeroLead = 'Дадим понятные ответы по налоговым вопросам, проверим спорные ситуации, подготовим рекомендации по учету, отчетности, договорам, требованиям ФНС и налоговым последствиям операций.';
...
$auditOrderReasonsTitle = 'Когда нужна услуга: консультации по налогам';

$auditOrderReasonsIntro = [
    'Консультации по налогам требуется, когда компании важно заранее оценить налоговые последствия, подготовить документы, снизить риски и принять безопасное управленческое решение.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];

$auditOrderReasonsItems = [
    'возник вопрос по расчету или уплате налогов',
    'нужно быстро проверить позицию бухгалтера или контрагента',
    'инспекция запросила пояснения или документы',
    'планируется сделка с налоговыми последствиями',
    'компания хочет понять риски до подачи отчетности',
    'требуется письменный ответ для руководства или внутреннего согласования',
];

$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает результат налоговых консультаций';
...
$auditQuestionsTitle = 'Какие задачи решает консультации по налогам';
...
$auditServiceTypesIntro = 'Консультации по налогам может быть выполнена в виде разовой консультации, письменной позиции, анализа документов или комплексного сопровождения. Формат зависит от срочности, рисков и количества материалов.';
...
$auditProcessTitle = 'Как проходит консультации по налогам';
...
$auditPricingIntro = 'Стоимость налоговых консультаций рассчитывается индивидуально и зависит от объема документов, срочности, сложности налоговой ситуации и необходимости сопровождения после подготовки результата.';
...
$auditResultsSummaryTitle = 'Что вы получите по итогам налоговых консультаций';
...
$auditMandatoryPrepTitle = 'Есть вопрос по налогам? Разберем ситуацию';
...
$auditFinalCtaTitle = 'Нужна консультации по налогам? Начнем с анализа модели';
...
$auditFaqTitle = 'Частые вопросы: консультации по налогам';

$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Консультации по налогам»?',
...
<body class="has-site-header has-breadcrumbs page-konsalting-konsultatsii-po-nalogam">
