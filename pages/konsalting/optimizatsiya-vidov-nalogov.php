...
$pageTitle = 'Оптимизация видов налогов';

$pageDescription = 'Оптимизация видов налогов ООО "Аудит Топ Эксперт": анализ НДС, налога на прибыль, УСН, НДФЛ, страховых взносов и других налоговых обязательств.';

$serviceCoverHeroTitle = 'Оптимизация видов налогов';

$serviceCoverHeroLead = 'Проверим налоговую нагрузку по отдельным видам налогов, найдем законные возможности для корректировки учета и документов, оценим риски и подготовим рекомендации по безопасной оптимизации.';
...
$auditOrderReasonsTitle = 'Когда нужна услуга: оптимизация видов налогов';

$auditOrderReasonsIntro = [
    'Оптимизация видов налогов требуется, когда компании важно заранее оценить налоговые последствия, подготовить документы, снизить риски и принять безопасное управленческое решение.',
    'Чаще всего услугу заказывают в следующих ситуациях:',
];

$auditOrderReasonsItems = [
    'нужно отдельно проверить НДС, налог на прибыль, УСН, НДФЛ или страховые взносы',
    'есть высокая нагрузка по конкретному налогу',
    'требуется понять, какие расходы, льготы или режимы применяются корректно',
    'нужно проверить вычеты, налоговую базу и подтверждающие документы',
    'компания хочет снизить риски по одному проблемному участку',
    'важно оценить последствия изменений в операциях или договорах',
];

$auditOrderReasonsCtaLabel = 'Оставить заявку';

$auditCheckResultsTitle = 'Что показывает результат оптимизации видов налогов';
...
$auditQuestionsTitle = 'Какие задачи решает оптимизация видов налогов';
...
$auditServiceTypesIntro = 'Оптимизация видов налогов может быть выполнена в виде разовой консультации, письменной позиции, анализа документов или комплексного сопровождения. Формат зависит от срочности, рисков и количества материалов.';
...
$auditProcessTitle = 'Как проходит оптимизация видов налогов';
...
$auditPricingIntro = 'Стоимость оптимизации видов налогов рассчитывается индивидуально и зависит от объема документов, срочности, сложности налоговой ситуации и необходимости сопровождения после подготовки результата.';
...
$auditResultsSummaryTitle = 'Что вы получите по итогам оптимизации видов налогов';
...
$auditMandatoryPrepTitle = 'Нужно оптимизировать отдельные налоги? Начнем с анализа';
...
$auditFinalCtaTitle = 'Нужна оптимизация видов налогов? Начнем с анализа модели';
...
$auditFaqTitle = 'Частые вопросы: оптимизация видов налогов';

$auditFaqItems = [
    [
        'q' => 'Что входит в услугу «Оптимизация видов налогов»?',
...
<body class="has-site-header has-breadcrumbs page-konsalting-optimizatsiya-vidov-nalogov">
